...
es.caib.portafib.pluginsib.validatesignature.utilitatsfirma.password=<<username>>
es.caib.portafib.pluginsib.validatesignature.utilitatsfirma.languageui=ca', NULL, NULL, true, 4, 'VALIDA_UTILFIRMA', 1, 2, 2, NULL);
