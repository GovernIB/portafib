...
BEGIN
    ...
    execute immediate ('create sequence pfi_grupentitatusuarientit_seq start with ' || seqvalue || ' increment by 1');
    ...
    execute immediate ('create sequence pfi_pluginfirmawebperusrap_seq start with ' || seqvalue || ' increment by 1');
    execute immediate ('create sequence pfi_pluginfirmawebperusren_seq start with ' || seqvalue || ' increment by 1');
    ...
    execute immediate ('GRANT SELECT ON pfi_grupentitatusuarientit_seq TO www_portafib');
    ...
    execute immediate ('GRANT SELECT ON pfi_pluginfirmawebperusrap_seq TO www_portafib');
    execute immediate ('GRANT SELECT ON pfi_pluginfirmawebperusren_seq TO www_portafib');
