...
create sequence pfi_grupentitatusuarientitat_seq start 1000 increment 1;
...
create sequence pfi_pluginfirmawebperusrapp_seq start 1000 increment 1;
create sequence pfi_pluginfirmawebperusrent_seq start 1000 increment 1;
...
select setval('pfi_grupentitatusuarientitat_seq',  (SELECT nextval('pfi_portafib_seq')));
...
select setval('pfi_pluginfirmawebperusrapp_seq',  (SELECT nextval('pfi_portafib_seq')));
select setval('pfi_pluginfirmawebperusrent_seq',  (SELECT nextval('pfi_portafib_seq')));
...
alter table pfi_grupentitatusuarientitat alter grupentitatusuarientitatid set DEFAULT nextval('pfi_grupentitatusuarientitat_seq');
...
alter table pfi_pluginfirmawebperusrapp alter pluginfirmawebperusrappid set DEFAULT nextval('pfi_pluginfirmawebperusrapp_seq');
alter table pfi_pluginfirmawebperusrent alter pluginfirmawebperusrentid set DEFAULT nextval('pfi_pluginfirmawebperusrent_seq');
