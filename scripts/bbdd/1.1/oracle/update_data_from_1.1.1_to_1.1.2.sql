...
INSERT INTO pfi_propietatglobal(propietatglobalid, clau, valor, descripcio) VALUES (pfi_portafib_seq.nextval ,'es.caib.portafib.activeusuarientitatafteragentseyconcreation', NULL, 'Opcional. En entorns CAIB, quan un agent seycon dóna d´alta un usuari a PortaFIB, emprant aquesta propietat podem decidir si aquest usuari-entitat es crearà activat (true) o desactivat (false o no definit)');
