 ...
 -- INICI GRANTS
    grant select,insert,delete,update on pfi_algorismedefirma to www_portafib;
    ...
    grant select,insert,delete,update on pfi_tipusestatdefirmafinal to www_portafib;
    grant select,insert,delete,update on pfi_tipusestatdefirmainicial to www_portafib;
    grant select,insert,delete,update on pfi_tipusestatpeticiodefirma to www_portafib;
    grant select,insert,delete,update on pfi_tipusfirma to www_portafib;
    grant select,insert,delete,update on pfi_tipusmetadada to www_portafib;
    ...
    grant select,insert,delete,update on pfi_usuarientitatrevisor to www_portafib;
