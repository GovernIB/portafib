 ...
 * @author anadal
 */
public class PeticioDeFirmaValidator<I extends PeticioDeFirma>
    extends org.fundaciobit.genapp.common.validation.AbstractValidator    implements PeticioDeFirmaFields {
  ...
  public void validate(IValidatorResult<I> __vr,I __target__, boolean __isNou__
    ...
    if (__vr.getFieldErrorCount(DESCRIPCIOTIPUSDOCUMENT) == 0) {
      java.lang.String __descripciotipusdocument = __target__.getDescripcioTipusDocument();
    ...
    if (__vr.getFieldErrorCount(MOTIUDEREBUIG) == 0) {
      java.lang.String __motiuderebuig = __target__.getMotiuDeRebuig();
    ...
    if (__vr.getFieldErrorCount(SOLICITANTUSUARIAPLICACIOID) == 0) {
      java.lang.String __solicitantusuariaplicacioid = __target__.getSolicitantUsuariAplicacioID();
    ...
    if (__vr.getFieldErrorCount(REMITENTNOM) == 0) {
      java.lang.String __remitentnom = __target__.getRemitentNom();
    ...
    if (__vr.getFieldErrorCount(REMITENTDESCRIPCIO) == 0) {
      java.lang.String __remitentdescripcio = __target__.getRemitentDescripcio();
    ...
    if (__vr.getFieldErrorCount(EXPEDIENTCODI) == 0) {
      java.lang.String __expedientcodi = __target__.getExpedientCodi();
    ...
    if (__vr.getFieldErrorCount(EXPEDIENTNOM) == 0) {
      java.lang.String __expedientnom = __target__.getExpedientNom();
    ...
    if (__vr.getFieldErrorCount(EXPEDIENTURL) == 0) {
      java.lang.String __expedienturl = __target__.getExpedientUrl();
    ...
    if (__vr.getFieldErrorCount(INFORMACIOADDICIONAL) == 0) {
      java.lang.String __informacioaddicional = __target__.getInformacioAddicional();
    ...
    if (__vr.getFieldErrorCount(SOLICITANTUSUARIENTITAT1ID) == 0) {
      java.lang.String __solicitantusuarientitat1id = __target__.getSolicitantUsuariEntitat1ID();
    ...
    if (__vr.getFieldErrorCount(SOLICITANTUSUARIENTITAT2ID) == 0) {
      java.lang.String __solicitantusuarientitat2id = __target__.getSolicitantUsuariEntitat2ID();
    ...
    if (__vr.getFieldErrorCount(SOLICITANTUSUARIENTITAT3ID) == 0) {
      java.lang.String __solicitantusuarientitat3id = __target__.getSolicitantUsuariEntitat3ID();
    ...
    if (__isNou__) { // Creació
      ...
      if (__vr.getFieldErrorCount(FLUXDEFIRMESID) == 0) {
        java.lang.Long __fluxdefirmesid = __target__.getFluxDeFirmesID();
        Long __count_ = null;
    ...
    if (__vr.getFieldErrorCount(CONFIGURACIODEFIRMAID) == 0) {
      java.lang.Long __configuraciodefirmaid = __target__.getConfiguracioDeFirmaID();
