 ...
 * @author anadal
 */
public class PluginFirmaWebPerUsuariEntitatValidator<I extends PluginFirmaWebPerUsuariEntitat>
    extends org.fundaciobit.genapp.common.validation.AbstractValidator    implements PluginFirmaWebPerUsuariEntitatFields {
  ...
  public void validate(IValidatorResult<I> __vr,I __target__, boolean __isNou__
    ...
    if (__isNou__) { // Creació
      ...
      if (__vr.getFieldErrorCount(USUARIENTITATID) == 0 && __vr.getFieldErrorCount(PLUGINFIRMAWEBID) == 0 && __vr.getFieldErrorCount(PLUGINFIRMAWEBPERUSRENTID) == 0) {
        java.lang.String __usuarientitatid = __target__.getUsuariEntitatID();
        java.lang.Long __pluginfirmawebid = __target__.getPluginFirmaWebID();
        java.lang.Long __pluginfirmawebperusrentid = __target__.getPluginFirmaWebPerUsrEntID();
        Long __count_ = null;
