...
public class PermisUsuariPlantillaJPAManager
         extends AbstractJPAManager<PermisUsuariPlantilla, Long>
         implements PermisUsuariPlantillaIJPAManager, IPermisUsuariPlantillaManager, PermisUsuariPlantillaFields {
