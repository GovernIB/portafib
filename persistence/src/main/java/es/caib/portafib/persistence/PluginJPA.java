...
// EXP  Field:pluginid | Table: pfi_plugincridada | Type: 0  
...
// IMP Field:traduccioid | Table: pfi_traduccio | Type: 1  
  ...
  @javax.xml.bind.annotation.XmlTransient
  public java.util.Map<String, es.caib.portafib.persistence.TraduccioMapJPA> getDescripcioCurtaTraduccions() {
    return this.descripcioCurta.getTraduccions();
  }

  public void setDescripcioCurtaTraduccions(java.util.Map<String, es.caib.portafib.persistence.TraduccioMapJPA> __traduccions__) {
