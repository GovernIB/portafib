...
public class EntitatValidator<I extends Entitat>
  ...
  public void validate(IValidatorResult<I> __vr,I __target__, boolean __isNou__
    ...
    if (__vr.getFieldErrorCount(ENTITATID) == 0) {
      String val = __target__.getEntitatID();
    ...
    if (__vr.getFieldErrorCount(SUPORTEMAIL) == 0) {
      String val = __target__.getSuportEmail();
      if (val != null && val.trim().length() != 0) {
    ...
    if (__vr.getFieldErrorCount(PLUGINSEGELLTEMPSID) == 0) {
      java.lang.Long __pluginsegelltempsid = __target__.getPluginSegellTempsID();
    ...
    if (__vr.getFieldErrorCount(PLUGINRUBRICAID) == 0) {
      java.lang.Long __pluginrubricaid = __target__.getPluginRubricaID();
    ...
    if (__vr.getFieldErrorCount(PLUGINVALIDAFIRMESID) == 0) {
      java.lang.Long __pluginvalidafirmesid = __target__.getPluginValidaFirmesID();
    ...
    if (__vr.getFieldErrorCount(PLUGINVALIDACERTIFICATID) == 0) {
      java.lang.Long __pluginvalidacertificatid = __target__.getPluginValidaCertificatID();
