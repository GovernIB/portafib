 ...
 * @author anadal
 */
public class PerfilDeFirmaValidator<I extends PerfilDeFirma>
    extends org.fundaciobit.genapp.common.validation.AbstractValidator    implements PerfilDeFirmaFields {
  ...
  public void validate(IValidatorResult<I> __vr,I __target__, boolean __isNou__
    ...
    if (__vr.getFieldErrorCount(CONDICIO) == 0) {
      java.lang.String __condicio = __target__.getCondicio();
    ...
    if (__isNou__) { // Creació
      ...
      if (__vr.getFieldErrorCount(CODI) == 0 && __vr.getFieldErrorCount(USUARIAPLICACIOPERFILID) == 0) {
        java.lang.String __codi = __target__.getCodi();
        java.lang.Long __usuariaplicacioperfilid = __target__.getUsuariAplicacioPerfilID();
        Long __count_ = null;
    ...
    if (__vr.getFieldErrorCount(CONFIGURACIODEFIRMA1ID) == 0) {
      java.lang.Long __configuraciodefirma1id = __target__.getConfiguracioDeFirma1ID();
      Long __count_ = null;
    ...
    if (__vr.getFieldErrorCount(CONFIGURACIODEFIRMA2ID) == 0) {
      java.lang.Long __configuraciodefirma2id = __target__.getConfiguracioDeFirma2ID();
    ...
    if (__vr.getFieldErrorCount(CONFIGURACIODEFIRMA3ID) == 0) {
      java.lang.Long __configuraciodefirma3id = __target__.getConfiguracioDeFirma3ID();
    ...
    if (__vr.getFieldErrorCount(CONFIGURACIODEFIRMA4ID) == 0) {
      java.lang.Long __configuraciodefirma4id = __target__.getConfiguracioDeFirma4ID();
    ...
    if (__vr.getFieldErrorCount(CONFIGURACIODEFIRMA5ID) == 0) {
      java.lang.Long __configuraciodefirma5id = __target__.getConfiguracioDeFirma5ID();
