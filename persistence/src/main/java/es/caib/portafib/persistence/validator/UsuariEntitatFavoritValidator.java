 ...
 * @author anadal
 */
public class UsuariEntitatFavoritValidator<I extends UsuariEntitatFavorit>
    extends org.fundaciobit.genapp.common.validation.AbstractValidator    implements UsuariEntitatFavoritFields {
  ...
  public void validate(IValidatorResult<I> __vr,I __target__, boolean __isNou__
    ...
    if (__vr.getFieldErrorCount(ORIGENID) == 0) {
      java.lang.String __origenid = __target__.getOrigenID();
    ...
    if (__vr.getFieldErrorCount(FAVORITID) == 0) {
      java.lang.String __favoritid = __target__.getFavoritID();
