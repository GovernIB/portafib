 ...
 * @author anadal
 */
public class PluginFirmaWebPerUsuariAplicacioValidator<I extends PluginFirmaWebPerUsuariAplicacio>
    extends org.fundaciobit.genapp.common.validation.AbstractValidator    implements PluginFirmaWebPerUsuariAplicacioFields {
  ...
  public void validate(IValidatorResult<I> __vr,I __target__, boolean __isNou__
    ...
    if (__isNou__) { // Creació
      ...
      if (__vr.getFieldErrorCount(USUARIAPLICACIOID) == 0 && __vr.getFieldErrorCount(PLUGINFIRMAWEBID) == 0) {
        java.lang.String __usuariaplicacioid = __target__.getUsuariAplicacioID();
        java.lang.Long __pluginfirmawebid = __target__.getPluginFirmaWebID();
        Long __count_ = null;
      ...
      if (__vr.getFieldErrorCount(USUARIAPLICACIOID) == 0 && __vr.getFieldErrorCount(PLUGINFIRMAWEBID) == 0 && __vr.getFieldErrorCount(PLUGINFIRMAWEBPERUSRAPPID) == 0) {
        java.lang.String __usuariaplicacioid = __target__.getUsuariAplicacioID();
        java.lang.Long __pluginfirmawebid = __target__.getPluginFirmaWebID();
        java.lang.Long __pluginfirmawebperusrappid = __target__.getPluginfirmawebperusrappid();
        Long __count_ = null;
