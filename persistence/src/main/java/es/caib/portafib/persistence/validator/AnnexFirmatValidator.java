 ...
 * @author anadal
 */
public class AnnexFirmatValidator<I extends AnnexFirmat>
    extends org.fundaciobit.genapp.common.validation.AbstractValidator    implements AnnexFirmatFields {
  ...
  public void validate(IValidatorResult<I> __vr,I __target__, boolean __isNou__
    ...
    if (__vr.getFieldErrorCount(ANNEXID) == 0) {
      java.lang.Long __annexid = __target__.getAnnexID();
      Long __count_ = null;
