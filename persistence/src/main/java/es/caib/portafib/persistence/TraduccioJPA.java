...
// EXP  Field:firmatperformatid | Table: pfi_usuariaplicacioconfig | Type: 0  
  ...
  public void setTraduccions(Map<String, es.caib.portafib.persistence.TraduccioMapJPA> _traduccions_) {
  ...
  public es.caib.portafib.persistence.TraduccioMapJPA getTraduccio(String idioma) {
    return (es.caib.portafib.persistence.TraduccioMapJPA) traduccions.get(idioma);
  }
  
  public void addTraduccio(String idioma, es.caib.portafib.persistence.TraduccioMapJPA traduccio) {
    if (traduccio == null) {
