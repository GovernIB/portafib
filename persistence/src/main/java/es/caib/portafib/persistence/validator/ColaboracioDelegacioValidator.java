 ...
 * @author anadal
 */
public class ColaboracioDelegacioValidator<I extends ColaboracioDelegacio>
    extends org.fundaciobit.genapp.common.validation.AbstractValidator    implements ColaboracioDelegacioFields {
  ...
  public void validate(IValidatorResult<I> __vr,I __target__, boolean __isNou__
    ...
    if (__vr.getFieldErrorCount(COLABORADORDELEGATID) == 0) {
      java.lang.String __colaboradordelegatid = __target__.getColaboradorDelegatID();
    ...
    if (__vr.getFieldErrorCount(MOTIUDESHABILITADA) == 0) {
      java.lang.String __motiudeshabilitada = __target__.getMotiuDeshabilitada();
