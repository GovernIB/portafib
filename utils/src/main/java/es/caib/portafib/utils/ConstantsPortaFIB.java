...
public interface ConstantsPortaFIB {
 ...
 public static final int POLITICA_TAULA_FIRMES_DEFINIT_EN_ENTITAT = -1;
  ...
  public static final int[] POLITICA_CUSTODIA_EN_ENTITAT = new int[] {
    ConstantsV2.POLITICA_CUSTODIA_NO_PERMETRE,
    ConstantsV2.POLITICA_CUSTODIA_NOMES_PLANTILLES_ENTITAT,
    ConstantsV2.POLITICA_CUSTODIA_OBLIGATORI_PLANTILLA_DEFINIDA,
    ConstantsV2.POLITICA_CUSTODIA_OPCIONAL_PLANTILLA_DEFINIDA_DEFECTE_ACTIU,
    ConstantsV2.POLITICA_CUSTODIA_OPCIONAL_PLANTILLA_DEFINIDA_DEFECTE_NO_ACTIU,
    ConstantsV2. POLITICA_CUSTODIA_LLIBERTAT_TOTAL 
  };
  
  //TOTES les de la configuració d'usuari aplicació
  public static final int[] POLITICA_CUSTODIA_EN_USR_APP_CONFIG = new int[] { 
    ConstantsV2.POLITICA_CUSTODIA_EL_DEFINIT_EN_ENTITAT,
    ConstantsV2.POLITICA_CUSTODIA_NO_PERMETRE,
    ConstantsV2.POLITICA_CUSTODIA_NOMES_PLANTILLES_ENTITAT,
    ConstantsV2.POLITICA_CUSTODIA_OBLIGATORI_PLANTILLA_DEFINIDA,
    ConstantsV2.POLITICA_CUSTODIA_OPCIONAL_PLANTILLA_DEFINIDA_DEFECTE_ACTIU,
