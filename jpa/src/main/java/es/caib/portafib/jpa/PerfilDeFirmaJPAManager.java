...
public class PerfilDeFirmaJPAManager
		 extends AbstractPortaFIBJPAManager<PerfilDeFirma, Long>
		 implements IPerfilDeFirmaManager, PerfilDeFirmaFields {
  ...
  static final ModificationManager<PerfilDeFirma> __eventManager = new ModificationManager<PerfilDeFirma>();
  ...
  protected EntityManager getEntityManager() {
	...
	public ModificationManager<PerfilDeFirma> getEventManager() {
