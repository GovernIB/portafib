...
public class TipusNotificacioJPAManager
		 extends AbstractPortaFIBJPAManager<TipusNotificacio, Long>
		 implements ITipusNotificacioManager, TipusNotificacioFields {
  ...
  static final ModificationManager<TipusNotificacio> __eventManager = new ModificationManager<TipusNotificacio>();
  ...
  protected EntityManager getEntityManager() {
	...
	public ModificationManager<TipusNotificacio> getEventManager() {
