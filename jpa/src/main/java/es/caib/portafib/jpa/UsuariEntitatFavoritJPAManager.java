...
public class UsuariEntitatFavoritJPAManager
		 extends AbstractPortaFIBJPAManager<UsuariEntitatFavorit, Long >
		 implements IUsuariEntitatFavoritManager, UsuariEntitatFavoritFields {
  ...
  static final ModificationManager<UsuariEntitatFavorit> __eventManager = new ModificationManager<UsuariEntitatFavorit>();
  ...
  protected EntityManager getEntityManager() {
	...
	public ModificationManager<UsuariEntitatFavorit> getEventManager() {
