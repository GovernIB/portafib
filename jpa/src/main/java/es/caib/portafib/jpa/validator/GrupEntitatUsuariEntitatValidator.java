 ...
 * @author anadal
 */
public class GrupEntitatUsuariEntitatValidator<T> implements GrupEntitatUsuariEntitatFields {
  ...
  public void validate(IValidatorResult<T> __vr, T __target__, boolean __isNou__
    ...
    if (__isNou__) { // Creació
      ...
      if (__vr.getFieldErrorCount(USUARIENTITATID) == 0 && __vr.getFieldErrorCount(GRUPENTITATID) == 0 && __vr.getFieldErrorCount(GRUPENTITATUSUARIENTITATID) == 0) {
        java.lang.String __usuarientitatid = (java.lang.String)__vr.getFieldValue(__target__,USUARIENTITATID);
        java.lang.Long __grupentitatid = (java.lang.Long)__vr.getFieldValue(__target__,GRUPENTITATID);
        java.lang.Long __grupentitatusuarientitatid = (java.lang.Long)__vr.getFieldValue(__target__,GRUPENTITATUSUARIENTITATID);
        Long __count_ = null;
