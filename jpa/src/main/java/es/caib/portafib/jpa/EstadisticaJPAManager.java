...
public class EstadisticaJPAManager
  ...
  protected EntityManager getEntityManager() {
	...
	public synchronized Estadistica create( int _tipus_, java.sql.Timestamp _data_, java.lang.String _entitatID_, java.lang.Double _valor_, java.lang.String _parametres_) throws I18NException {
		EstadisticaJPA __bean =  new EstadisticaJPA(_tipus_,_data_,_entitatID_,_valor_,_parametres_);
