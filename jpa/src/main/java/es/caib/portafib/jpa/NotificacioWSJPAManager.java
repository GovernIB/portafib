...
public class NotificacioWSJPAManager
  ...
  static final ModificationManager<NotificacioWS> __eventManager = new ModificationManager<NotificacioWS>();
  ...
  protected EntityManager getEntityManager() {
	...
	public ModificationManager<NotificacioWS> getEventManager() {
