 ...
 * @author anadal
 */
public class PerfilsPerUsuariAplicacioValidator<T> implements PerfilsPerUsuariAplicacioFields {
  ...
  public void validate(IValidatorResult<T> __vr, T __target__, boolean __isNou__
    ...
    if (__isNou__) { // Creació
      ...
      if (__vr.getFieldErrorCount(PERFILDEFIRMAID) == 0 && __vr.getFieldErrorCount(USUARIAPLICACIOID) == 0) {
        java.lang.Long __perfildefirmaid = (java.lang.Long)__vr.getFieldValue(__target__,PERFILDEFIRMAID);
        java.lang.String __usuariaplicacioid = (java.lang.String)__vr.getFieldValue(__target__,USUARIAPLICACIOID);
        Long __count_ = null;
      ...
      if (__vr.getFieldErrorCount(PERFILDEFIRMAID) == 0 && __vr.getFieldErrorCount(USUARIAPLICACIOID) == 0 && __vr.getFieldErrorCount(PERFILSPERUSRAPPID) == 0) {
        java.lang.Long __perfildefirmaid = (java.lang.Long)__vr.getFieldValue(__target__,PERFILDEFIRMAID);
        java.lang.String __usuariaplicacioid = (java.lang.String)__vr.getFieldValue(__target__,USUARIAPLICACIOID);
        java.lang.Long __perfilsperusrappid = (java.lang.Long)__vr.getFieldValue(__target__,PERFILSPERUSRAPPID);
        Long __count_ = null;
