...
// EXP  Field:posiciotaulafirmesid | Table: pfi_usuariaplicacioconfig | Type: 0  
 ...
 // ---------------  STATIC METHODS ------------------
  ...
  static PosicioTaulaFirmesJPA copyJPA(PosicioTaulaFirmesJPA __jpa,
    ...
    if(!"UsuariAplicacioConfiguracioJPA".equals(origenJPA) 
      ...
      __tmp.setUsuariAplicacioConfiguracios(UsuariAplicacioConfiguracioJPA.copyJPA(__jpa.getUsuariAplicacioConfiguracios(), __alreadyCopied,"PosicioTaulaFirmesJPA"));
    }
