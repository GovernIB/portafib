...
public class Exemple {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println(
                    " Connectant amb " + testProperties.getProperty("test_host") + " emprant l'usuari " + usr_app);
            ...
            final String titol = "Peticio de Test amb Custodia - " + ((System.currentTimeMillis() / 1000) % 100000);
            ...
            if (custodiaInfoBean == null) {
                log.info("Avis: No hi ha sistema de custodia definit" + " o l´usuari aplicació " + usr_app
                        + " no pot custodiar");
            } else {
            ...
            if (getFitxerAAnnexar() == null) {
                annex = PeticioDeFirmaUtils.constructAnnexBeanFromResource("/annex.txt", "text/plain", true, true);
            } else {
                annex = PeticioDeFirmaUtils.constructAnnexBeanFromFile(new File(getFitxerAAnnexar()),
                        Constants.PDF_MIME_TYPE, true, true);
            }

            // Fitxer a Firmar
            FitxerBean fitxerAFirmar;
            if (getFitxerAFirmar() == null) {
                fitxerAFirmar = PeticioDeFirmaUtils.constructFitxerBeanFromResource("/test.pdf",
            ...
            peticioDeFirmaWs = PeticioDeFirmaUtils.constructPeticioDeFirma(apiUE, titol, remitent, fitxerAFirmar,
                    nifsDestinataris);
            ...
            try {
                ...
                if (isWaitToSign()) {
                    ...
                    if (estat == REBUTJAT) {
                        peticioDeFirmaWs = api.getPeticioDeFirma(peticioDeFirmaID);
                        System.err.println(
                                "La peticio de firma ha sigut rebutjada: " + peticioDeFirmaWs.getMotiuDeRebuig());
