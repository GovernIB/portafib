package es.caib.portafib.ws.api.v1.passarelafirmaweb.utils;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;

import es.caib.portafib.ws.api.v1.passarelafirmaweb.WsFieldValidationError;
import es.caib.portafib.ws.api.v1.passarelafirmaweb.WsI18NArgument;
import es.caib.portafib.ws.api.v1.passarelafirmaweb.WsI18NError;
import es.caib.portafib.ws.api.v1.passarelafirmaweb.WsI18NException;
import es.caib.portafib.ws.api.v1.passarelafirmaweb.WsI18NTranslation;
