...
public interface PortaFIBPassarelaDeFirmaWs {
    ...
    @WebResult(name = "return", targetNamespace = "")
    @RequestWrapper(localName = "providesTimeStampGenerator", targetNamespace = "http://impl.v1.ws.portafib.caib.es/", className = "es.caib.portafib.ws.api.v1.passarela.ProvidesTimeStampGenerator")
    @WebMethod
    @ResponseWrapper(localName = "providesTimeStampGeneratorResponse", targetNamespace = "http://impl.v1.ws.portafib.caib.es/", className = "es.caib.portafib.ws.api.v1.passarela.ProvidesTimeStampGeneratorResponse")
