 ...
 *
 */
@XmlType(name="passarelaPolicyInfoSignature")
public class PassarelaPolicyInfoSignatureWs {
   ...
   * 
   */
  public PassarelaPolicyInfoSignatureWs() {
  }
   ...
   */
  public PassarelaPolicyInfoSignatureWs(String policyIdentifier, String policyIdentifierHash,
