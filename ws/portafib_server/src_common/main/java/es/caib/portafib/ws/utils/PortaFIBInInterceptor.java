...
public class PortaFIBInInterceptor extends AbstractPhaseInterceptor<Message> {
    ...
    public void handleMessage(Message message) throws Fault {
        ...
        if (logEnable) {
            ...
            log.info("PortaFIBInInterceptor::handleMessage() =>  Thread = " + Thread.currentThread().getId());
        }
        ...
        if (logEnable) {
            ...
            log.info("PortaFIBInInterceptor::handleMessage() => PFI_USER " + context.isUserInRole(Constants.PFI_USER));
            log.info(
                    "PortaFIBInInterceptor::handleMessage() => PFI_ADMIN " + context.isUserInRole(Constants.PFI_ADMIN));
        }
        ...
        try {
            ...
            final String msg;
            msg = " Error intentant obtenir informació de l'usuari aplicació '" + userapp + "':  " + e.getMessage();
            log.error("PortaFIBInInterceptor::handleMessage()" + msg, e);
        ...
        if (Configuracio.isCAIB()) {
            ...
            if (usuariAplicacio == null) {
                ...
                final String msg = "L´usuari aplicació " + userapp + " està autenticat en el domini de seguretat,"
