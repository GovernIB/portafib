...
@javax.xml.bind.annotation.XmlType(name="passarelaSignaturesTableHeader")
public class PassarelaSignaturesTableHeaderWs {
   ...
   * 
   */
  public PassarelaSignaturesTableHeaderWs() {
    super();
  }
   ...
   */
  public PassarelaSignaturesTableHeaderWs(byte[] logoJpeg, String title, String titleFieldLabel,
