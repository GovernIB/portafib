...
public class PeticioDeFirmaBean {
    ...
    public PeticioDeFirmaBean(long peticioDeFirmaID, java.lang.String titol, java.lang.String descripcio,
            java.lang.String motiu, java.lang.Long fitxerAFirmarID, java.lang.Long fitxerAdaptatID,
            long tipusDocumentID, java.lang.String descripcioTipusDocument, int posicioTaulaFirmesID,
            java.sql.Timestamp dataSolicitud, java.sql.Timestamp dataFinal, java.sql.Timestamp dataCaducitat,
            int tipusFirmaID, int algorismeDeFirmaID, java.lang.Boolean modeDeFirma, int tipusEstatPeticioDeFirmaID,
            java.lang.String motiuDeRebuig, java.lang.String idiomaID, int prioritatID, long fluxDeFirmesID,
            java.lang.String usuariAplicacioID, java.lang.String remitentNom, java.lang.String remitentDescripcio,
            java.lang.String informacioAdicional, java.lang.Long logoSegellID, java.lang.Long custodiaInfoID,
            java.lang.String usuariEntitatID, boolean avisWeb, boolean segellatDeTemps) {
    ...
    public PeticioDeFirmaBean(java.lang.String titol, java.lang.String descripcio, java.lang.String motiu,
            java.lang.Long fitxerAFirmarID, java.lang.Long fitxerAdaptatID, long tipusDocumentID,
            java.lang.String descripcioTipusDocument, int posicioTaulaFirmesID, java.sql.Timestamp dataSolicitud,
            java.sql.Timestamp dataFinal, java.sql.Timestamp dataCaducitat, int tipusFirmaID, int algorismeDeFirmaID,
            java.lang.Boolean modeDeFirma, int tipusEstatPeticioDeFirmaID, java.lang.String motiuDeRebuig,
            java.lang.String idiomaID, int prioritatID, long fluxDeFirmesID, java.lang.String usuariAplicacioID,
            java.lang.String remitentNom, java.lang.String remitentDescripcio, java.lang.String informacioAdicional,
            java.lang.Long logoSegellID, java.lang.Long custodiaInfoID, java.lang.String usuariEntitatID,
            boolean avisWeb, boolean segellatDeTemps) {
        this.titol = titol;
        this.descripcio = descripcio;
        this.motiu = motiu;
        this.fitxerAFirmarID = fitxerAFirmarID;
    ...
    public PeticioDeFirmaBean(long peticioDeFirmaID, java.lang.String titol, java.lang.String motiu,
            long tipusDocumentID, int posicioTaulaFirmesID, java.sql.Timestamp dataCaducitat, int tipusFirmaID,
            int algorismeDeFirmaID, java.lang.Boolean modeDeFirma, int tipusEstatPeticioDeFirmaID,
            java.lang.String idiomaID, int prioritatID, long fluxDeFirmesID, java.lang.String usuariAplicacioID,
    ...
    public PeticioDeFirmaBean(PeticioDeFirma __bean) throws I18NException {
        this.setPeticioDeFirmaID(__bean.getPeticioDeFirmaID());
        this.setTitol(__bean.getTitol());
        this.setDescripcio(__bean.getDescripcio());
        this.setMotiu(__bean.getMotiu());
        if (__bean.getFitxerAFirmarID() == null) {
            this.setFitxerAFirmarID(0);
        } else {
        ...
        this.setModeDeFirma(PortaFIBPeticioDeFirmaWsImpl.convertPortafibSignMode2WSApi(__bean.getModeDeFirma()));
        ...
        this.setUsuariAplicacioID(__bean.getSolicitantUsuariAplicacioID());
        ...
        this.setUsuariEntitatID(__bean.getSolicitantUsuariEntitat1ID());
    ...
    public static PeticioDeFirmaBean toBean(PeticioDeFirma __bean) throws I18NException {
        if (__bean == null) {
            return null;
        }
        ...
        __tmp.setModeDeFirma(PortaFIBPeticioDeFirmaWsImpl.convertPortafibSignMode2WSApi(__bean.getModeDeFirma()));
        ...
        __tmp.setUsuariAplicacioID(__bean.getSolicitantUsuariAplicacioID());
        ...
        __tmp.setUsuariEntitatID(__bean.getSolicitantUsuariEntitat1ID());
