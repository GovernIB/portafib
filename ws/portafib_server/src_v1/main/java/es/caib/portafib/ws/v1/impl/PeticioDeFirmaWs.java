...
public class PeticioDeFirmaWs extends PeticioDeFirmaBean {
     ...
     * @param __bean
     */
    public PeticioDeFirmaWs(PeticioDeFirma __bean) throws I18NException {
        super(__bean);
    }
    ...
    // TODO EXCEPTION
    public static PeticioDeFirmaJPA toJPA(PeticioDeFirmaWs peticioDeFirmaWs, FitxerLogicaLocal fitxerEjb,
        ...
        if (peticioDeFirmaWs.getFitxerAFirmar() != null) {
            FitxerJPA f = fitxerEjb.createFitxerField(jpa.getFitxerAFirmar(),
                    new DataHandlerDataSource(jpa.getFitxerAFirmar().getData()), fitxersCreats,
        ...
        if (peticioDeFirmaWs.getFitxerAdaptat() != null) {
            FitxerJPA f = fitxerEjb.createFitxerField(jpa.getFitxerAdaptat(),
                    new DataHandlerDataSource(jpa.getFitxerAdaptat().getData()), fitxersCreats,
                    PeticioDeFirmaFields.FITXERADAPTATID);
        ...
        if (peticioDeFirmaWs.getLogoSegell() != null) {
            FitxerJPA f = fitxerEjb.createFitxerField(jpa.getLogoSegell(),
                    new DataHandlerDataSource(jpa.getLogoSegell().getData()), fitxersCreats,
        ...
        if (peticioDeFirmaWs.getFluxDeFirmes() != null) {
            jpa.setFluxDeFirmes(FluxDeFirmesWs.toJPA(peticioDeFirmaWs.getFluxDeFirmes(), fitxerEjb, fitxersCreats));
        }
    ...
    private static PeticioDeFirmaJPA toJPA(PeticioDeFirmaBean __bean) {
        ...
        __tmp.setModeDeFirma(PortaFIBPeticioDeFirmaWsImpl.convertPortafibSignMode2ApiSignMode(__bean.getModeDeFirma(),
                __bean.getTipusFirmaID()));
    ...
    public static PeticioDeFirmaWs toWs(PeticioDeFirmaJPA jpa) throws I18NException {
        if (jpa == null) {
            return null;
        }
