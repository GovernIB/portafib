...
/**
 * <p>Clase Java para deactivateUsuariEntitat complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="deactivateUsuariEntitat"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "deactivateUsuariEntitat", propOrder = {
    "usuariEntitatID"
})
public class DeactivateUsuariEntitat {
