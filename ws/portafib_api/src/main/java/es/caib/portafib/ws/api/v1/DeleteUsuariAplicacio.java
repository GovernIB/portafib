...
/**
 * <p>Clase Java para deleteUsuariAplicacio complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="deleteUsuariAplicacio"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "deleteUsuariAplicacio", propOrder = {
    "usuariAplicacioID"
})
public class DeleteUsuariAplicacio {
