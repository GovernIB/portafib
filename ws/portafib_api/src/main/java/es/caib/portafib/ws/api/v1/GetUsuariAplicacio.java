...
/**
 * <p>Clase Java para getUsuariAplicacio complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getUsuariAplicacio"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "getUsuariAplicacio", propOrder = {
    "usuariAplicacioID"
})
public class GetUsuariAplicacio {
