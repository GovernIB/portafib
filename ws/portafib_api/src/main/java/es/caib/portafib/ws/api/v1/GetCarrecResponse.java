...
/**
 * <p>Clase Java para getCarrecResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getCarrecResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "getCarrecResponse", propOrder = {
    "_return"
})
public class GetCarrecResponse {
