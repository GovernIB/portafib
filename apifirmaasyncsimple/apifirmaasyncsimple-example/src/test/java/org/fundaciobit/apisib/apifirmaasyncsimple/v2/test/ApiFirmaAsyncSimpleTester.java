...
public class ApiFirmaAsyncSimpleTester {
    ...
    public void getUrlToViewFlow(String languageUI, ApiFirmaAsyncSimple api) throws Exception {
    ...
    public void createSignatureRequestAndStart(String languageUI, ApiFirmaAsyncSimple api) throws Exception {
        ...
        try {
            ...
            if (signatureBlocks == null) {
                ...
                signatureRequest = new FirmaAsyncSimpleSignatureRequestWithFlowTemplateCode(signatureRequestBase,
                        plantillaDeFirmes);
    ...
    public void getTipusDeDocumentsDisponibles(final String languageUI, ApiFirmaAsyncSimple api)
        ...
        for (FirmaAsyncSimpleDocumentTypeInformation docType : documents) {
            System.out.println("[" + docType.getDocumentType() + "] " + docType.getName() + " (BASE => "
                    + docType.getDocumentTypeBase() + ")");
        }
    }

    public void getPerfilsDisponibles(final String languageUI, ApiFirmaAsyncSimple api) throws AbstractApisIBException {
    ...
    public void getIdiomesDisponibles(final String languageUI, ApiFirmaAsyncSimple api) throws AbstractApisIBException {
    ...
    public ApiFirmaAsyncSimple getApiFirmaAsyncSimple() throws Exception {
        ...
        api = new ApiFirmaAsyncSimpleJersey(host, username, testProperties.getProperty("password"));
