...
public class FirmaAsyncSimpleSignatureRequestBase {
  ...
  public FirmaAsyncSimpleSignatureRequestBase() {
    super();
  }

  public FirmaAsyncSimpleSignatureRequestBase(String profileCode, String title,
  ...
  public FirmaAsyncSimpleSignatureRequestBase(String profileCode, String title,
      ...
      String expedientUrl, String procedureCode, String procedureName,
      String additionalInformation, Double additionalInformationEvaluable,
      List<FirmaAsyncSimpleAnnex> annexs,
  ...
  public FirmaAsyncSimpleSignatureRequestBase(FirmaAsyncSimpleSignatureRequestBase base) {
    super();
