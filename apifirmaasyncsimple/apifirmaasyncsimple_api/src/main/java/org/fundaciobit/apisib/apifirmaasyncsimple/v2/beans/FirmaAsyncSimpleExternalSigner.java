...
public class FirmaAsyncSimpleExternalSigner {
  ...
  public FirmaAsyncSimpleExternalSigner() {
    super();
  }

  public FirmaAsyncSimpleExternalSigner(String administrationId, String name, String surnames,
