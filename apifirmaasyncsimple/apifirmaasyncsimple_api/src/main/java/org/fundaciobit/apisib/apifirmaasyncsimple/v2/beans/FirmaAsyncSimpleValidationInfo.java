...
public class FirmaAsyncSimpleValidationInfo {
  ...
  public FirmaAsyncSimpleValidationInfo() {
    super();
  }

  public FirmaAsyncSimpleValidationInfo(Boolean checkAdministrationIDOfSigner,
