...
import org.fundaciobit.apisib.apifirmaasyncsimple.v2.exceptions.TimeOutException;
 ...
 *
 */
abstract class AbstractApiFirmaAsyncSimpleJersey {
   ...
   * @param endPointBase
   */
  public AbstractApiFirmaAsyncSimpleJersey(String endPointBase) {
    super();
   ...
   * @param password
   */
  public AbstractApiFirmaAsyncSimpleJersey(String endPointBase, String username, String password) {
    this(endPointBase);
  ...
  protected ClientResponse commonCall(Object parameter, String method)
    ...
    if (response.getStatus() == 200) {
      ...
      FirmaAsyncSimpleError simple = null;
      try {
        simple = response.getEntity(FirmaAsyncSimpleError.class);
      } catch (Exception e) {
        // Error no controlat
      }
      ...
      if (simple != null) {
        ...
        if (tipus != null && tipus.trim().length() != 0) {
          ...
          if (tipus.equals(TimeOutException.class.getName())) {
