...
public class XadesInternallyDetachedParameters {
     ...
     * 
     */
    public XadesInternallyDetachedParameters() {
    }
     ...
     * @param type
     */
    public XadesInternallyDetachedParameters(String type, String certificate, String defaultDigestAlgorithm, SignatureTarget signatureTarget, Boolean includeDataObjectFormat, String defaultC14nMethod, XadesPolicyIdentifier policyIdentifier) {
        super();
        this.type = type;
