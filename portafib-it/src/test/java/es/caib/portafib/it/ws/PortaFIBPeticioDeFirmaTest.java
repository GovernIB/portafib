...
public class PortaFIBPeticioDeFirmaTest extends PortaFIBTestUtils {
  ...
  public void testPeticioDeFirmaAmbErrors() throws Exception {
    ...
    FitxerBean fitxerAFirmar = PeticioDeFirmaUtils.constructFitxerBeanFromResource("/testfiles/test.pdf",
  ...
  public void testPeticioDeFirma() throws Exception {
    ...
    String[] annexesResources = { "/testfiles/annex_1.txt", "/testfiles/annex_2.jpg", "/testfiles/annex_3.bin" };
