...
public class DestinatariUsuari extends Usuari implements Destinatari {

    private final String pin;

    public DestinatariUsuari(String administrationId, final String username, final String password, String pin,
                             String baseUrl) {
