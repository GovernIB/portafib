package es.caib.portafib.it.simple.async;

import es.caib.portafib.it.actors.Destinatari;
import es.caib.portafib.it.actors.DestinatariExtern;
import es.caib.portafib.it.actors.DestinatariUsuari;
import es.caib.portafib.it.actors.Revisor;
...
public class ApiFirmaAsyncTestBase {
    ...
    private FirmaAsyncSimpleFile getSimpleFile(String fileName, String mime) {
        try (InputStream is = getClass().getResourceAsStream("/testfiles/" + fileName)) {
            assert is != null;
