...
public interface ConstantsV2 {
    ...
    public static final int[] TIPUSESTATPETICIODEFIRMA = { TIPUSESTATPETICIODEFIRMA_NOINICIAT,
            TIPUSESTATPETICIODEFIRMA_ENPROCES, TIPUSESTATPETICIODEFIRMA_PAUSAT, TIPUSESTATPETICIODEFIRMA_REBUTJAT,
    ...
    public static final long[] TIPUSESTATDEFIRMAINICIAL = new long[] { TIPUSESTATDEFIRMAINICIAL_ASSIGNAT_PER_VALIDAR,
            TIPUSESTATDEFIRMAINICIAL_ASSIGNAT_PER_FIRMAR, TIPUSESTATDEFIRMAINICIAL_REVISANT_PER_VALIDAR,
    ...
    public static final long[] TIPUSESTATDEFIRMAFINAL = new long[] { TIPUSESTATDEFIRMAFINAL_VALIDAT,
            TIPUSESTATDEFIRMAFINAL_INVALIDAT, TIPUSESTATDEFIRMAFINAL_FIRMAT, TIPUSESTATDEFIRMAFINAL_REBUTJAT,
    ...
    /**
     * @deprecated See Constants.CONTEXT_ADAPP_NOTIFICACIONSWS. Aquest context s'ha de mantenir per compatibilitat
     *  amb les versions anteriors però no s'ha d'utilitzar en cap
     */
    @Deprecated(since = "3.0.12", forRemoval = true)
    public static final String CONTEXT_ADEN_NOTIFICACIONSWS = "/adapp/notificaciows";
    public static final String CONTEXT_ADAPP_NOTIFICACIONSWS = "/adapp/notificaciows";
    ...
    */
    ...
    public static final int[] ESTADISTICA_TIPUS = { ESTADISTICA_TIPUS_APIFIRMASIMPLE_SERVIDOR_OK,
            ESTADISTICA_TIPUS_APIFIRMASIMPLE_SERVIDOR_ERROR, ESTADISTICA_TIPUS_APIFIRMASIMPLE_UPGRADE_OK,
            ESTADISTICA_TIPUS_APIFIRMASIMPLE_UPGRADE_ERROR, ESTADISTICA_TIPUS_APIFIRMASIMPLE_SINCRONA_CREADA,
            ESTADISTICA_TIPUS_APIFIRMASIMPLE_SINCRONA_OK, ESTADISTICA_TIPUS_APIFIRMASIMPLE_SINCRONA_CANCEL,
            ESTADISTICA_TIPUS_APIFIRMASIMPLE_SINCRONA_ERROR, ESTADISTICA_TIPUS_APIFIRMASIMPLE_ASINCRONA_CREADA,
            ESTADISTICA_TIPUS_APIFIRMASIMPLE_ASINCRONA_OK, ESTADISTICA_TIPUS_APIFIRMASIMPLE_ASINCRONA_CANCEL,
            ESTADISTICA_TIPUS_APIFIRMASIMPLE_ASINCRONA_ERROR, ESTADISTICA_TIPUS_APIFIRMASIMPLE_ASINCRONA_FIRMA,
    ...
    public static final int[] ESTADISTIQUES_GRUPS_VALIDATE = { ESTADISTICA_GRUP_APISWAGGER_VALIDATEV1,
    ...
    public static final Map<Integer, List<Integer>> ESTADISTIQUES_BY_GRUP = Map.of(
            ...
            // ------------------  ESTADISTICA_GRUP_PORTAFIB_VALIDATE
            ESTADISTICA_GRUP_PORTAFIB_VALIDATE,
            List.of(ESTADISTICA_TIPUS_PORTAFIB_VALIDATE_VALID, ESTADISTICA_TIPUS_PORTAFIB_VALIDATE_INVALID,
                    ESTADISTICA_TIPUS_PORTAFIB_VALIDATE_ERROR),
    ...
    public static final int[] POLITICA_PLUGIN_FIRMA_WEB = new int[] { POLITICA_PLUGIN_FIRMA_WEB_NOMES_PLUGINS_ENTITAT,
            POLITICA_PLUGIN_FIRMA_WEB_ENTITAT_I_ADDICIONALS, POLITICA_PLUGIN_FIRMA_WEB_NOMES_ADDICIONALS };
    ...
    public static final int[] PLUGIN_POLITICA_DE_US = { PLUGIN_POLITICA_DE_US_PLANTILLA,
            PLUGIN_POLITICA_DE_US_NOMES_ENTITAT, PLUGIN_POLITICA_DE_US_USAR_TOTHOM };
    ...
    public static final int MAX_FIRMES_PER_TAULA = (A4_ALT - LOWER_MARGIN_PAGE - SIGNBOX_START) / SIGNBOX_HEIGHT; // ~10;  
    ...
    int BITACOLA_TIPUS_FLUX_DE_FIRMES = 4;

    int[] BITACOLA_TIPUS = { BITACOLA_TIPUS_PETICIO, BITACOLA_TIPUS_FIRMASINCRONA, BITACOLA_TIPUS_CONFIGURACIO,
            BITACOLA_TIPUS_FLUX_DE_FIRMES };
    ...
    //Específiques de Peticions de firma: revisats
    int BITACOLA_OP_AFEGIR_REVISOR = 51;
    int BITACOLA_OP_REVISOR_ACEPTAR = 52;
    int BITACOLA_OP_REVISOR_REBUTJAR = 53;

    // Específiques de Peticions de firma: errors
    int BITACOLA_OP_ERROR_NOTIFICACIO = 90;

    int[] BITACOLA_OP = { BITACOLA_OP_CREAR, BITACOLA_OP_ACTUALITZAR, BITACOLA_OP_ESBORRAR, BITACOLA_OP_INICIAR,
            ...
            BITACOLA_OP_EMAIL_USUARI_EXTERN, BITACOLA_OP_AFEGIR_REVISOR, BITACOLA_OP_REVISOR_ACEPTAR,
            BITACOLA_OP_REVISOR_REBUTJAR, BITACOLA_OP_ERROR_NOTIFICACIO };
