    ...
    public ResponseEntity<?> getAvisosPeticioPerRol(HttpServletRequest request,
        ...
        try {
            ...
            if (person.getIntermediateServerUsername() != null) {
                ...
                String username = usuariEntitatLogicaEjb.executeQueryOne(UsuariEntitatFields.USUARIPERSONAID,
                ...
                if (usuariPersona == null) {
                    // XYZ ZZZ TRA
                    throw new I18NException("genapp.comodi", "No existeix la persona amb username " + username);
                }
                ...
                if (usuariPersona == null) {
                    // XYZ ZZZ TRA
                    throw new I18NException("genapp.comodi", "No existeix la persona amb NIF " + administrationID);
                }
            ...
            for (UsuariEntitatJPA ue : usuariEntitats) {
                ...
                avisosPeticio = estatDeFirmaLogicaEjb.getAvisosUsuariEntitat(usuariEntitatID, entitatID, roles);
                ...
                for (Map.Entry<String, List<Long>> entry : avisosPeticio.entrySet()) {
                    ...
                    for (StringKeyValue skv : skvList) {
                        ...
                        list.add(
                                new ExternalSignaturePeticio(Long.parseLong(skv.getKey()), skv.getValue(), peticioUrl));
                    }
                }
            }
            ...
            ResponseEntity<?> re = new ResponseEntity<ExternalSignatureAvisosPeticioResponse>(resp, headers,
                    HttpStatus.OK);
            ...
            // XYZ ZZZ TRA
            String msg = "Error desconegut durant el procés de consulta de les Peticions: " + th.getMessage();
            log.error(msg, th);
