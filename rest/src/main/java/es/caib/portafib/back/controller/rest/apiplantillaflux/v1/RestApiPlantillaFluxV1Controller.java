...
public class RestApiPlantillaFluxV1Controller extends RestUtilsErrorManager {
    ...
    @RequestMapping(value = "/" + ApiFlowTemplateSimple.AVAILABLELANGUAGES, method = RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value = "/" + ApiFlowTemplateSimple.GETTRANSACTIONID, method = RequestMethod.POST)
    @ResponseBody
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes(MediaType.APPLICATION_JSON)
    public ResponseEntity<?> getTransactionID(HttpServletRequest request,
        ...
        UsuariAplicacioJPA usuariAplicacio = LoginInfo.getInstance().getUsuariAplicacio();
        if (usuariAplicacio == null) {
            // TODO Traduccio
            return generateServerError("Usuari Aplicació no està registrat a PortaFIB");
        }

        //currentTransactions.put(transactionID, new TransactionInfo(transactionID, usuariAplicacio, transactionIDRequest));
    ...
    @RequestMapping(value = "/" + ApiFlowTemplateSimple.STARTTRANSACTION, method = RequestMethod.POST)
    @ResponseBody
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes(MediaType.APPLICATION_JSON)
    public ResponseEntity<?> startTransaction(HttpServletRequest request,
        ...
        try {
            ...
            if (ti.getStatus().getStatus() != FlowTemplateSimpleStatus.STATUS_RESERVED_ID) {
                // TODO XYZ ZZZ Traduir
                return generateServerError("La transacció " + transactionID + " es troba en un estat ja iniciat");
            }
            ...
            */
            ...
            // XYZ ZZZ TRA
            String msg = "Error desconegut iniciant la pantalla de Plantilla de Flux de Firmes: " + th.getMessage();
    ...
    @RequestMapping(value = "/" + ApiFlowTemplateSimple.GETALLFLOWTEMPLATESBYFILTER, method = RequestMethod.POST)
    @ResponseBody
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes(MediaType.APPLICATION_JSON)
    ...
    @RequestMapping(value = "/" + ApiFlowTemplateSimple.GETFLOWINFOBYFLOWTEMPLATEID, method = RequestMethod.POST)
    @ResponseBody
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes(MediaType.APPLICATION_JSON)
    ...
    @RequestMapping(value = "/" + ApiFlowTemplateSimple.GETFLOWTEMPLATERESULT, method = RequestMethod.POST)
    @ResponseBody
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes(MediaType.APPLICATION_JSON)
    public ResponseEntity<?> getFlowTemplateResult(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            FlowTemplateSimpleGetFlowResultResponse result = new FlowTemplateSimpleGetFlowResultResponse(status,
                    flowInfo, properties);
    ...
    protected FlowTemplateSimpleFlowTemplate getFlowTemplateInfo(Long fluxDeFirmesID) throws I18NException, Exception {
        ...
        for (BlocDeFirmesJPA blocJPA : blocsJPA) {
            ...
            for (FirmaJPA firmaJPA : blocJPA.getFirmas()) {
                ...
                FlowTemplateSimpleSignature signature = new FlowTemplateSimpleSignature(signer, required, reason,
    ...
    @RequestMapping(value = "/" + ApiFlowTemplateSimple.CLOSETRANSACTION, method = RequestMethod.POST)
    @ResponseBody
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes(MediaType.APPLICATION_JSON)
    ...
    @RequestMapping(value = "/" + ApiFlowTemplateSimple.GETALLFLOWTEMPLATES, method = RequestMethod.POST)
    @ResponseBody
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes(MediaType.APPLICATION_JSON)
    ...
    @RequestMapping(value = "/" + ApiFlowTemplateSimple.GETURLTOVIEWFLOWTEMPLATE, method = RequestMethod.POST)
    @ResponseBody
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes(MediaType.APPLICATION_JSON)
    ...
    @RequestMapping(value = "/" + ApiFlowTemplateSimple.GETURLTOEDITFLOWTEMPLATE, method = RequestMethod.POST)
    @ResponseBody
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes(MediaType.APPLICATION_JSON)
    ...
    @RequestMapping(value = "/" + ApiFlowTemplateSimple.DELETEFLOWTEMPLATE, method = RequestMethod.POST)
    @ResponseBody
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes(MediaType.APPLICATION_JSON)
