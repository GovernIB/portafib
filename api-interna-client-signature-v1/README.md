...
*SignatureFlowTemplateV1Api* | [**updateDescriptionOfFlowTemplate**](docs/SignatureFlowTemplateV1Api.md#updateDescriptionOfFlowTemplate) | **PATCH** /secure/signatureflowtemplate/v1/updateDescriptionOfFlowTemplate/{flowTemplateID} | Actualitza la descripció d&#39;una Plantilla de Flux de Firmes a partir del seu ID
