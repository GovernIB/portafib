 ...
 */
@JsonPropertyOrder({
  FileInfoSignature.JSON_PROPERTY_FILE_TO_SIGN,
  FileInfoSignature.JSON_PROPERTY_PREVIUS_SIGNATURE_DETACHED_FILE,
...
public class FileInfoSignature {
  ...
  private Document previusSignatureDetachedFile;
  ...
  public FileInfoSignature fileToSign(@javax.annotation.Nonnull Document fileToSign) {
  ...
  public FileInfoSignature previusSignatureDetachedFile(@javax.annotation.Nullable Document previusSignatureDetachedFile) {
  ...
  @JsonProperty(JSON_PROPERTY_PREVIUS_SIGNATURE_DETACHED_FILE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPreviusSignatureDetachedFile(@javax.annotation.Nullable Document previusSignatureDetachedFile) {
    this.previusSignatureDetachedFile = previusSignatureDetachedFile;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.fileToSign, fileInfoSignature.fileToSign) &&
        Objects.equals(this.previusSignatureDetachedFile, fileInfoSignature.previusSignatureDetachedFile) &&
        Objects.equals(this.signID, fileInfoSignature.signID) &&
