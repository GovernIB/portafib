...
import es.caib.portafib.api.interna.secure.firma.v1.FirmaSimpleSignDocumentRequest;
...
public abstract class RestApiFirmaSimpleUtils<K extends ApisIBKeyValue> extends RestFirmaUtils<K> {
    ...
    public PerfilDeFirma getPerfilDeFirma(FirmaSimpleCommonInfo commonInfo, final boolean esFirmaEnServidor, String username)
            throws I18NException {
