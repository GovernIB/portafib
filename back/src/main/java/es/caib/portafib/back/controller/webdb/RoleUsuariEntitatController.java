...
public class RoleUsuariEntitatController
  ...
  public String editarRoleUsuariEntitatPost(@ModelAttribute @Valid RoleUsuariEntitatForm roleUsuariEntitatForm,
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  public List<StringKeyValue> getReferenceListForRoleID(HttpServletRequest request,
    ...
    final String _fieldName =  roleUsuariEntitatForm.getStringOfField(ROLEID);
    Where _where = null;
    if (roleUsuariEntitatForm.isReadOnlyField(_fieldName)) {
  ...
  public List<StringKeyValue> getReferenceListForUsuariEntitatID(HttpServletRequest request,
    ...
    final String _fieldName =  roleUsuariEntitatForm.getStringOfField(USUARIENTITATID);
    Where _where = null;
    if (roleUsuariEntitatForm.isReadOnlyField(_fieldName)) {
