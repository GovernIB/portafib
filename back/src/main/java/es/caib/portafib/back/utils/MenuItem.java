...
public class MenuItem {
  ...
  final static String[] menu1 = {
      ...
      "", "usuaripersona.alta", "usuaripersona.modificar", "usuarientitat.gestio", "",
      "carrec.gestio", "colaboradordecarrec.plural", "solicitant.gestio", "revisor.gestio",
      "grups.gestio", "", "moduldefirmaenservidor.gestio", "",
      "moduldefirma.gestio",
      ...
      "peticionsdefirma.destinatari", "peticiodefirma.netejaesborrat", "",
      "estadistica.estadistica.plural", "bitacola.menu" };
  ...
  static {
    ...
    mapping
        .put(CONFIGURACIO_DE_FIRMA, ConfiguracioDeFirmaAdenController.CONTEXT_WEB + "/list");
    ...
    mapping.put("peticiodefirma.usrapp.llistar", ConstantsV2.CONTEXT_ADEN_PETICIOFIRMA_USRAPP
        + "/list");
    ...
    for (int i = 0; i < menu2.length; i++) {
      ...
      if (id.equals("")) {
        ...
        if (url.endsWith("/list")) {
          System.out.println(" menu2.add(MenuItem.retallaDarrerPath(\"" + menu2[i] + "\", \""
              + url + "\"));");
        } else {

          System.out.println(" menu2.add(new MenuItem(\"" + menu2[i] + "\", \""
              + url + "\"));");
