 ...
 * @author GenApp
 */
@MenuOption(labelCode="bitacola.bitacola.plural", order=20, group=Tab.MENU_WEBDB)
@Controller
...
public class BitacolaController
  ...
  public String editarBitacolaPost(@ModelAttribute BitacolaForm bitacolaForm,
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de Bitacola
   */
  @RequestMapping(value = "/cancel")
  public String cancelBitacola(HttpServletRequest request,HttpServletResponse response) {
