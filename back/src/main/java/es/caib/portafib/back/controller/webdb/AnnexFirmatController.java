 ...
 * @author GenApp
 */
@MenuOption(labelCode="annexFirmat.annexFirmat.plural", order=10, group=Tab.MENU_WEBDB)
@Controller
...
public class AnnexFirmatController
  ...
  public String editarAnnexFirmatPost(@ModelAttribute AnnexFirmatForm annexFirmatForm,
