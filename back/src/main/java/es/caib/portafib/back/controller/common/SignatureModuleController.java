...
public class SignatureModuleController extends HttpServlet {
    ...
    public ModelAndView selectSignModules(HttpServletRequest request, HttpServletResponse response,
        ...
        if (pluginsFirmaPerTipusDoc == null || pluginsFirmaPerTipusDoc.size() == 0) {
            try {
                ...
                if (emprarUsuariEntitat) {
                    ...
                    // usuaris aplicació
                    Set<String> usuarisAplicacio = new HashSet<String>(
                            signaturesSet.getApplicationBySignatureID().values());
                    log.info("Emprant plugins de l'usuari entitat: " + usuariEntitatID + ", i aplicacions: "
                            + usuarisAplicacio);
        ...
        for (Plugin modulDeFirmaJPA : moduls) {
            ...
            try {
                signaturePlugin = modulDeFirmaEjb.getInstanceByPluginID(modulDeFirmaJPA.getPluginID());
            } catch (I18NException e) {
    ...
    public ModelAndView showSignatureModule(HttpServletRequest request, HttpServletResponse response,
        ...
        if (log.isDebugEnabled()) {
            log.debug("relativeControllerBase: " + relativeControllerBase);
        }

        String relativeRequestPluginBasePath = getRequestPluginBasePath(relativeControllerBase, signaturesSetID, -1);
        ...
        String absoluteRequestPluginBasePath = getRequestPluginBasePath(absoluteControllerBase, signaturesSetID, -1);
        //log.info("absoluteRequestPluginBasePath: " + absoluteRequestPluginBasePath);

        String newFinalUrl = response
                .encodeURL(absoluteControllerBase + "/final/" + URLEncoder.encode(signaturesSetID, "UTF-8"));
     ...
     */
    protected void requestPlugin(HttpServletRequest request, HttpServletResponse response, String signaturesSetID,
            int signatureIndex, String query, boolean isPost) {
        ...
        String relativeRequestPluginBasePath = getRelativeRequestPluginBasePath(request, getContextWeb(),
                signaturesSetID, signatureIndex);

        //log.info("SignatureModuleController:absoluteRequestPluginBasePath => " + absoluteRequestPluginBasePath);
        //log.info("SignatureModuleController:relativeRequestPluginBasePath => " + relativeRequestPluginBasePath);

        if (isPost) {
            signaturePlugin.requestPOST(absoluteRequestPluginBasePath, relativeRequestPluginBasePath, query,
                    signaturesSetID, signatureIndex, request, response);
        } else {
            signaturePlugin.requestGET(absoluteRequestPluginBasePath, relativeRequestPluginBasePath, query,
                    signaturesSetID, signatureIndex, request, response);
        }
    ...
    private static void closeSignaturesSet(HttpServletRequest request, PortaFIBSignaturesSet pss,
            ModulDeFirmaWebLogicaLocal modulDeFirmaEjb) {
    ...
    protected ModelAndView generateErrorMAV(HttpServletRequest request, String signaturesSetID, String msg,
            Throwable th) {
    ...
    protected ModelAndView generateErrorMAV(HttpServletRequest request, PortaFIBSignaturesSet pss, String msg,
            Throwable th) {
    ...
    protected void generateErrorAndRedirect(HttpServletRequest request, HttpServletResponse response,
    ...
    protected static String processError(HttpServletRequest request, PortaFIBSignaturesSet pss, String msg,
            Throwable th) {
    ...
    public static SignaturesSetWeb getSignaturesSetByID(HttpServletRequest request, String signaturesSetID,
            ModulDeFirmaWebLogicaLocal modulDeFirmaEjb) {
     ...
     * @return
     */
    public static PortaFIBSignaturesSet getPortaFIBSignaturesSet(HttpServletRequest request, String signaturesSetID,
            ModulDeFirmaWebLogicaLocal modulDeFirmaEjb) {
    ...
    protected static String getAbsoluteRequestPluginBasePath(String baseUrl, String webContext, String signaturesSetID,
            int signatureIndex) {
    ...
    private static String getRequestPluginBasePath(String base, String signaturesSetID, int signatureIndex) {
