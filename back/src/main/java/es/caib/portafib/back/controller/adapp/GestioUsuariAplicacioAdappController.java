...
public class GestioUsuariAplicacioAdappController extends UsuariAplicacioController {
    ...
    public List<StringKeyValue> getReferenceListForEntitatID(HttpServletRequest request, ModelAndView mav, Where where)
        ...
        if (isAdmin()) {
            ...
            StringKeyValue skvEntitat = new StringKeyValue(entitatJPA.getEntitatID(), entitatJPA.getNom());
    ...
    @Override
    public List<StringKeyValue> getReferenceListForCallbackVersio(HttpServletRequest request, ModelAndView mav,
            Where where) {
    ...
    public UsuariAplicacioFilterForm getUsuariAplicacioFilterForm(Integer pagina, ModelAndView mav,
        ...
        if (usuariAplicacioFilterForm.isNou()) {
            ...
            usuariAplicacioFilterForm
                    .addAdditionalButtonForEachItem(new AdditionalButton("fas fa-cog", "pluginfirmaweb.veure",
    ...
    @Override
    public void postValidate(HttpServletRequest request, UsuariAplicacioForm usuariAplicacioForm, BindingResult result)
            throws I18NException {
    ...
    public String validarURLCallBack(@PathVariable("usuariAplicacioID") java.lang.String usuariAplicacioID,
        ...
        try {
            ...
            UsuariAplicacioJPA usuariAplicacio = this.usuariAplicacioLogicaEjb.findByPrimaryKey(usuariAplicacioID);

            // Error provant la URL de CallBack({0}) de l'usuari aplicació {1} : {2}
            String error = I18NUtils.tradueix("validar.urlcallback.error", usuariAplicacio.getCallbackURL(),
                    usuariAplicacio.getUsuariAplicacioID(), e.getMessage());

            HtmlUtils.saveMessageError(request,
                    error + "<br/>" + ExceptionUtils.getStackTrace(e).replace("\n", "<br/>"));
    ...
    public ModelAndView activarUsuariEntitat(@PathVariable("usuariAplicacioID") String usuariAplicacioID,
    ...
    public ModelAndView desactivarUsuariEntitat(@PathVariable("usuariAplicacioID") String usuariAplicacioID,
            HttpServletRequest request, HttpServletResponse response) {
    ...
    public UsuariAplicacioJPA create(HttpServletRequest request, UsuariAplicacioJPA usuariAplicacio)
        ...
        return usuariAplicacioLogicaEjb.createFull(usuariAplicacio, LoginInfo.getInstance().getEntitatID());
    }
    ...
    public List<StringKeyValue> getReferenceListForCustodiaInfoID(HttpServletRequest request, ModelAndView mav,
            UsuariAplicacioForm configuracioForm, Where where) throws I18NException {
