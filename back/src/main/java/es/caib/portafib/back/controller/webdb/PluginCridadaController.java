...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de PluginCridada
   */
  @RequestMapping(value = "/cancel")
  public String cancelPluginCridada(HttpServletRequest request,HttpServletResponse response) {
