 ...
 * @author GenApp
 */
@MenuOption(labelCode="usuariAplicacio.usuariAplicacio.plural", order=420, group=Tab.MENU_WEBDB)
@Controller
...
public class UsuariAplicacioController
  ...
  public Map<Field<?>, GroupByItem> fillReferencesForList(UsuariAplicacioFilterForm filterForm,
    ...
    // Field custodiaInfoID
    {
      ...
      fillValuesToGroupByItemsBoolean("tipusrevisors", groupByItemsMap, TIPUSREVISORS);
...
public java.lang.String stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de UsuariAplicacio
   */
  @RequestMapping(value = "/cancel")
  public String cancelUsuariAplicacio(HttpServletRequest request,HttpServletResponse response) {
