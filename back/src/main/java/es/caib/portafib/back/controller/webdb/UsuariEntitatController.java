...
public class UsuariEntitatController
    extends es.caib.portafib.back.controller.PortaFIBFilesBaseController<UsuariEntitatJPA, UsuariEntitatForm> implements UsuariEntitatFields {
  ...
  public String crearUsuariEntitatPost(@ModelAttribute UsuariEntitatForm usuariEntitatForm,
    ...
    try {
      ...
      if (result.hasErrors()) {
        ...
        return getRedirectWhenCreated(usuariEntitatForm);
      }
    } catch (Throwable __e) {
      afm.processErrorFilesWithoutThrowException(); // FILE
  ...
  protected ModelAndView editAndViewUsuariEntitatGet(@PathVariable("usuariEntitatID") java.lang.String usuariEntitatID,
    ...
    if (usuariEntitat == null) {
      ...
      new ModelAndView(new RedirectView(getRedirectWhenCancel(usuariEntitatID), true));
  ...
  public String editarUsuariEntitatPost(@ModelAttribute @Valid UsuariEntitatForm usuariEntitatForm,
    ...
    try {
      ...
      log.error(msg, __e);
      return getRedirectWhenModified(usuariEntitatForm, __e);
    }
  ...
  public String eliminarUsuariEntitat(@PathVariable("usuariEntitatID") java.lang.String usuariEntitatID,
    ...
    try {
      ...
      if (usuariEntitat == null) {
        ...
        return getRedirectWhenDelete(usuariEntitatID, new Exception(__msg));
      } else {
        delete(request, usuariEntitat);
        createMessageSuccess(request, "success.deleted", usuariEntitatID);
        return getRedirectWhenDelete(usuariEntitatID,null);
      }

    } catch (Throwable e) {
      String msg = createMessageError(request, "error.deleting", usuariEntitatID, e);
      log.error(msg, e);
      return getRedirectWhenDelete(usuariEntitatID, e);
    }
  }
...
public java.lang.String stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  // FILE
  @Override
  public void setFilesFormToEntity(FilesFormManager<Fitxer> afm, UsuariEntitatJPA usuariEntitat,
  ...
  // FILE
  @Override
  public void deleteFiles(UsuariEntitatJPA usuariEntitat) {
