 ...
 * @author GenApp
 */
@MenuOption(labelCode="plantillaFluxDeFirmes.plantillaFluxDeFirmes.plural", order=240, group="WEBDB")
@Controller
...
public class PlantillaFluxDeFirmesController
  ...
  public String editarPlantillaFluxDeFirmesPost(@ModelAttribute PlantillaFluxDeFirmesForm plantillaFluxDeFirmesForm,
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de PlantillaFluxDeFirmes
   */
  @RequestMapping(value = "/cancel")
  public String cancelPlantillaFluxDeFirmes(HttpServletRequest request,HttpServletResponse response) {
