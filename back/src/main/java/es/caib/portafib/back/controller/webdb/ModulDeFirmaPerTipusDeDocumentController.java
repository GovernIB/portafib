...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de ModulDeFirmaPerTipusDeDocument
   */
  @RequestMapping(value = "/cancel")
  public String cancelModulDeFirmaPerTipusDeDocument(HttpServletRequest request,HttpServletResponse response) {
  ...
  public void delete(HttpServletRequest request, ModulDeFirmaPerTipusDeDocument modulDeFirmaPerTipusDeDocument) throws I18NException {
