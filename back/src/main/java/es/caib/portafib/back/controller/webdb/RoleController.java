 ...
 * @author GenApp
 */
@MenuOption(labelCode="role.role.plural", order=350, group=Tab.MENU_WEBDB)
@Controller
...
public class RoleController
  ...
  public String editarRolePost(@ModelAttribute RoleForm roleForm,
...
public java.lang.String stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de Role
   */
  @RequestMapping(value = "/cancel")
  public String cancelRole(HttpServletRequest request,HttpServletResponse response) {
  ...
  public void delete(HttpServletRequest request, Role role) throws I18NException {
    roleEjb.delete(role);
  }
