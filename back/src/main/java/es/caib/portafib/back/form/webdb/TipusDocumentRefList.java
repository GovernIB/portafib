 ...
 */
@Component
public class TipusDocumentRefList extends RefListBase implements TipusDocumentFields {
    ...
    public List<StringKeyValue> getReferenceList(Field<?> keyField, Where where, OrderBy ... orderBy) throws I18NException {
        ...
        _w1 = es.caib.portafib.model.fields.TraduccioFields.TRADUCCIOID.in(tipusDocumentEjb.getSubQuery(_transSelect, where));
