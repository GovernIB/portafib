...
public abstract class AbstractParallelSignedFilesProcessing extends Thread {
    ...
    public AbstractParallelSignedFilesProcessing(HttpServletRequest request, String signaturesSetID,
            ...
            for (int i = signedFiles.length - 1; i >= 0; i--) {
                ...
                synchronized (status) {
                    ...
                    try {
                        ...
                        if (isDebug) {
                            log.debug(
                                    "(Thread)    [" + i + "]  Processat Signature " + signedFile.getSignID() + " ...");
                        }
    ...
    public abstract void process(final FileInfoSignature signedFileInfo, File firmat, int originalNumberOfSigns)
