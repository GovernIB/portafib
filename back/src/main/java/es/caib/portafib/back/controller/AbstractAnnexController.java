...
public abstract class AbstractAnnexController extends AnnexController {
  ...
  @Override
  public void postValidate(HttpServletRequest request, AnnexForm annexForm,
    ...
    int tipusFirma = peticioDeFirmaLogicaEjb.executeQueryOne(
        PeticioDeFirmaFields.TIPUSFIRMAID,
    ...
    switch (tipusFirma) {
      ...
      case ConstantsV2.TIPUSFIRMA_PADES:
        if ((!annex.isAdjuntar() && annex.isFirmar())
          ...
          result.rejectValue(AnnexFields.ADJUNTAR.fullName, "peticiodefirma.annexos.novalid",
              null, null);
          result.rejectValue(AnnexFields.FIRMAR.fullName, "peticiodefirma.annexos.novalid",
              null, null);
        }
      break;
  ...
  public AnnexFilterForm getAnnexFilterForm(Integer pagina, ModelAndView mav,
    ...
    int estat = peticioDeFirmaLogicaEjb.executeQueryOne(
  ...
  @Override
  public AnnexForm getAnnexForm(AnnexJPA _jpa, boolean __isView, HttpServletRequest request,
    ...
    if (annexForm.isNou()) {
      ...
      if (peticioDeFirmaID == null) {
        ...
        throw new I18NException("genapp.comodi",
            "peticioDeFirmaID val null en creació d'Annexe");
      }
