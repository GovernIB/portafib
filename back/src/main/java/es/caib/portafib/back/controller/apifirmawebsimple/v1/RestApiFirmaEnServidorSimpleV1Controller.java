...
import org.fundaciobit.apifirmawebsimple.ApiFirmaEnServidorSimple;
...
public class RestApiFirmaEnServidorSimpleV1Controller extends RestApiFirmaUtils {
  ...
  public ResponseEntity<?> signDocuments(
      @RequestBody FirmaEnServidorSimpleSignaturesSet simpleSignaturesSet) {
    ...
    try {
      ...
      FirmaSimpleSignatureStatus statusSignatureProcess = new FirmaSimpleSignatureStatus(
      ...
      for (PassarelaSignatureResult psr : passarelaSR) {
        ...
        results.add(new FirmaSimpleSignatureResult(psr.getStatus(), psr.getErrorMessage(), psr
            .getErrorStackTrace(), psr.getSignID(), RestApiFirmaWebSimpleV1Controller
            .convertFitxerBeanToFirmaSimpleFile(psr.getSignedFile())));

      }

      FirmaSimpleSignatureFullResults fssfr;
      fssfr = new FirmaSimpleSignatureFullResults(statusSignatureProcess, results);

      HttpHeaders headers = addAccessControllAllowOrigin();
      ResponseEntity<?> re = new ResponseEntity<FirmaSimpleSignatureFullResults>(fssfr,
