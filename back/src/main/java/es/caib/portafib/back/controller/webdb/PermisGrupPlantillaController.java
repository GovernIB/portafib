 ...
 * @author GenApp
 */
@MenuOption(labelCode="permisGrupPlantilla.permisGrupPlantilla.plural", order=210, group="WEBDB")
@Controller
...
public class PermisGrupPlantillaController
  ...
  public String editarPermisGrupPlantillaPost(@ModelAttribute PermisGrupPlantillaForm permisGrupPlantillaForm,
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de PermisGrupPlantilla
   */
  @RequestMapping(value = "/cancel")
  public String cancelPermisGrupPlantilla(HttpServletRequest request,HttpServletResponse response) {
  ...
  public void delete(HttpServletRequest request, PermisGrupPlantilla permisGrupPlantilla) throws I18NException {
