 ...
 * @author GenApp
 */
@MenuOption(labelCode="codiBarres.codiBarres.plural", order=40, group=Tab.MENU_WEBDB)
@Controller
...
public java.lang.String stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de CodiBarres
   */
  @RequestMapping(value = "/cancel")
  public String cancelCodiBarres(HttpServletRequest request,HttpServletResponse response) {
