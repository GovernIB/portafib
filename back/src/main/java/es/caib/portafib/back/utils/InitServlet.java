...
public class InitServlet extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        try {
            ...
            String msg = "\n\nError inicialitzant el sistema de sistema de fitxers: " + th.getMessage() + "\n\n";
            log.error(msg, th);
        ...
        try {
            ...
            if (pkgsTxt == null || pkgsTxt.trim().length() == 0) {
                ...
                if (plugins.length == 0) {
                    ...
                    for (String class1 : plugins) {
                        ...
                        if (edp == null) {
                            throw new ServletException("No s'ha pogut carregar el DataExporter: " + class1
                                    + ". Revisi el fitxer portafib.properties");
                        } else {
                            log.info("Registrant DataExporter: " + class1);
            ...
            throw new ServletException("Error inicialitzant els DataExporters: " + e.getMessage(), e);
        }
        ...
        try {
            ...
            log.error("Error desconegut inicialitzant Timer d'enviament" + " de notificacions agrupades: "
                    + th.getMessage(), th);
        }
