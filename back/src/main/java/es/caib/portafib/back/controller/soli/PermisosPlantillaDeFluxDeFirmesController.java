...
@SessionAttributes(
        types = { PlantillaFluxDeFirmesForm.class, PlantillaFluxDeFirmesFilterForm.class, SeleccioUsuariForm.class })
public class PermisosPlantillaDeFluxDeFirmesController extends PlantillaFluxDeFirmesController {
    ...
    protected ModelAndView editAndViewPlantillaFluxDeFirmesGet(
        ...
        return super.editAndViewPlantillaFluxDeFirmesGet(fluxDeFirmesID, request, response, __isView);
    }

    @Override
    public PlantillaFluxDeFirmesForm getPlantillaFluxDeFirmesForm(PlantillaFluxDeFirmesJPA _jpa, boolean __isView,
            HttpServletRequest request, ModelAndView mav) throws I18NException {

        PlantillaFluxDeFirmesForm plantillaFluxDeFirmesForm;

        plantillaFluxDeFirmesForm = super.getPlantillaFluxDeFirmesForm(_jpa, __isView, request, mav);

        plantillaFluxDeFirmesForm.getHiddenFields()
                .addAll(Arrays.asList(PlantillaFluxDeFirmesFields.ALL_PLANTILLAFLUXDEFIRMES_FIELDS));
        ...
        plantillaFluxDeFirmesForm.addAdditionalButton(new AdditionalButton(" fas fa-long-arrow-alt-left icon-white",
                "tornar", getContextWeb() + "/tornar", AdditionalButtonStyle.PRIMARY));
    ...
    public Map<String, String> refreshGrupsDisponibles(HttpServletRequest request, Long fluxDeFirmesID)
        ...
        skvlist = grupEntitatEjb.select(Where.AND(GrupEntitatFields.GRUPENTITATID.notIn(grupsActuals),
    ...
    public PlantillaFluxDeFirmesJPA findByPrimaryKey(HttpServletRequest request, java.lang.Long fluxDeFirmesID)
            throws I18NException {
        return (PlantillaFluxDeFirmesJPA) plantillaFluxDeFirmesLogicaEjb.findByPrimaryKeyFull(fluxDeFirmesID);
    }
    ...
    public String allowUserToPlantilla(
        ...
        long plantillafluxDeFirmesID = plantillaFluxDeFirmesForm.getPlantillaFluxDeFirmes().getFluxDeFirmesID();

        {
            ...
            String usuariEntitatID = seleccioUsuariForm.getId();
            {
                ...
                try {
                    ...
                    UsuariEntitatJPA ueJPA = usuariEntitatLogicaEjb.findByPrimaryKeyFull(usuariEntitatID);

                    pup.setUsuariEntitat(ueJPA);

                    plantillaFluxDeFirmesForm.getPlantillaFluxDeFirmes().getPermisUsuariPlantillas().add(pup);
    ...
    public String deleteUserFromPlantilla(
            @ModelAttribute("plantillaFluxDeFirmesForm") @Valid PlantillaFluxDeFirmesForm plantillaFluxDeFirmesForm,
            @RequestParam("userToDeleteFromPlantilla") String usuariEntitatID, HttpServletRequest request)
            throws I18NException {
    ...
    public String allowGroupToPlantilla(
            @ModelAttribute("plantillaFluxDeFirmesForm") @Valid PlantillaFluxDeFirmesForm plantillaFluxDeFirmesForm,
            @RequestParam("groupToAdd") Long grupEntitatID, HttpServletRequest request, HttpServletResponse response)
            throws I18NException {
        ...
        if (grupEntitatID == null) {
            ...
            HtmlUtils.saveMessageError(request,
                    I18NUtils.tradueix("error.notfound", I18NUtils.tradueix("grupEntitat.grupEntitat"),
                            I18NUtils.tradueix("grupEntitat.grupEntitatID"), String.valueOf(grupEntitatID)));
        } else {
            ...
            try {
                ...
                plantillaFluxDeFirmesForm.getPlantillaFluxDeFirmes().getPermisGrupPlantillas().add(pgp);
    ...
    public String deleteGroupFromPlantilla(
            @ModelAttribute("plantillaFluxDeFirmesForm") @Valid PlantillaFluxDeFirmesForm plantillaFluxDeFirmesForm,
            @RequestParam("groupToDeleteFromPlantilla") Long grupEntitatID, HttpServletRequest request)
            throws I18NException {
