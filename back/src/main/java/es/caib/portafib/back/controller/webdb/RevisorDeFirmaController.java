 ...
 * @author GenApp
 */
@MenuOption(labelCode="revisorDeFirma.revisorDeFirma.plural", order=340, group=Tab.MENU_WEBDB)
@Controller
...
public class RevisorDeFirmaController
  ...
  public String editarRevisorDeFirmaPost(@ModelAttribute RevisorDeFirmaForm revisorDeFirmaForm,
  ...
  public String eliminarRevisorDeFirma(@PathVariable("revisorDeFirmaID") java.lang.Long revisorDeFirmaID,
    ...
    try {
      RevisorDeFirma revisorDeFirma = this.findByPrimaryKey(request, revisorDeFirmaID);
      if (revisorDeFirma == null) {
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  public String getSessionAttributeFilterForm() {
    return "RevisorDeFirma_FilterForm_" + this.getClass().getName();
  }
  ...
  public void delete(HttpServletRequest request, RevisorDeFirma revisorDeFirma) throws I18NException {
