 ...
 * @author GenApp
 */
@MenuOption(labelCode="pluginFirmaWebPerUsuariAplicacio.pluginFirmaWebPerUsuariAplicacio.plural", order=270, group=Tab.MENU_WEBDB)
@Controller
...
@Tile(name="pluginFirmaWebPerUsuariAplicacioFormWebDB", contentJsp="/WEB-INF/jsp/webdb/pluginFirmaWebPerUsuariAplicacioForm.jsp", extendsTile=Tab.MENU_WEBDB,
      type=TileType.WEBDB_FORM , attributes={ @TileAttribute(name="titol", value="pluginFirmaWebPerUsuariAplicacio.pluginFirmaWebPerUsuariAplicacio")})
@Tile(name="pluginFirmaWebPerUsuariAplicacioListWebDB", contentJsp="/WEB-INF/jsp/webdb/pluginFirmaWebPerUsuariAplicacioList.jsp", extendsTile=Tab.MENU_WEBDB,
       type=TileType.WEBDB_LIST, attributes={ @TileAttribute(name="titol", value="pluginFirmaWebPerUsuariAplicacio.pluginFirmaWebPerUsuariAplicacio") })
public class PluginFirmaWebPerUsuariAplicacioController
  ...
  public String editarPluginFirmaWebPerUsuariAplicacioPost(@ModelAttribute PluginFirmaWebPerUsuariAplicacioForm pluginFirmaWebPerUsuariAplicacioForm,
  ...
  public String eliminarPluginFirmaWebPerUsuariAplicacio(@PathVariable("pluginfirmawebperusrappid") java.lang.Long pluginfirmawebperusrappid,
    ...
    try {
      PluginFirmaWebPerUsuariAplicacio pluginFirmaWebPerUsuariAplicacio = this.findByPrimaryKey(request, pluginfirmawebperusrappid);
      if (pluginFirmaWebPerUsuariAplicacio == null) {
 ...
 exceptionMsg };
  ...
  public List<StringKeyValue> getReferenceListForAccio(HttpServletRequest request,
    ...
    if (pluginFirmaWebPerUsuariAplicacioFilterForm.isHiddenField(ACCIO)
       ...
       && !pluginFirmaWebPerUsuariAplicacioFilterForm.isFilterByField(ACCIO)) {
      return EMPTY_STRINGKEYVALUE_LIST;
    }
    Where _w = null;
  ...
  public String getSessionAttributeFilterForm() {
    return "PluginFirmaWebPerUsuariAplicacio_FilterForm_" + this.getClass().getName();
  }
