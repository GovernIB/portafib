...
public class BitacolaAdenController extends AbstractBitacolaAdenController {
    ...
    @Override
    public void preList(HttpServletRequest request, ModelAndView mav, BitacolaFilterForm filterForm)
            throws I18NException {
    ...
    @Override
    public void postList(HttpServletRequest request, ModelAndView mav, BitacolaFilterForm filterForm,
            List<Bitacola> list) throws I18NException {
        String objecteId = (String) request.getAttribute(OBJECTEID_REQUEST_ATTRIBUTE);
        if (objecteId != null) {
