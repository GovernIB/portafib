 ...
 * @author GenApp
 */
@MenuOption(labelCode="usuariPersona.usuariPersona.plural", order=440, group=Tab.MENU_WEBDB)
@Controller
...
public class UsuariPersonaController
  ...
  public String editarUsuariPersonaPost(@ModelAttribute UsuariPersonaForm usuariPersonaForm,
...
public java.lang.String stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de UsuariPersona
   */
  @RequestMapping(value = "/cancel")
  public String cancelUsuariPersona(HttpServletRequest request,HttpServletResponse response) {
