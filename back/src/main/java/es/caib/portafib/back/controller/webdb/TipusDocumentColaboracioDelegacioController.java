 ...
 * @author GenApp
 */
@MenuOption(labelCode="tipusDocumentColaboracioDelegacio.tipusDocumentColaboracioDelegacio.plural", order=380, group=Tab.MENU_WEBDB)
@Controller
...
public class TipusDocumentColaboracioDelegacioController
  ...
  public String editarTipusDocumentColaboracioDelegacioPost(@ModelAttribute TipusDocumentColaboracioDelegacioForm tipusDocumentColaboracioDelegacioForm,
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de TipusDocumentColaboracioDelegacio
   */
  @RequestMapping(value = "/cancel")
  public String cancelTipusDocumentColaboracioDelegacio(HttpServletRequest request,HttpServletResponse response) {
