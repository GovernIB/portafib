...
public class GestioUsuariEntitatAdenController extends UsuariEntitatController {
    ...
    public UsuariEntitatForm getUsuariEntitatForm(UsuariEntitatJPA _jpa, boolean __isView, HttpServletRequest request,
        ...
        if (usuariEntitatForm.isNou()) {
            ...
            boolean esUsuariIntern = this.usuariEntitatLogicaEjb.executeQueryOne(
                    new UsuariEntitatQueryPath().USUARIPERSONA().USUARIINTERN(), UsuariEntitatFields.USUARIENTITATID
                            .equal(usuariEntitatForm.getUsuariEntitat().getUsuariEntitatID()));
            ...
            if (esUsuariIntern) {
                ...
                if (count == 0) {
                    ...
                    usuariEntitatForm.addAdditionalButton(
                            new AdditionalButton("fas fa-plus-circle", "usuarientitat.rolesolicitant",
            ...
            usuariEntitatForm.addAdditionalButton(new AdditionalButton("fas fa-cog", "pluginfirmaweb.veure",
    ...
    public String addSolicitantRole(HttpServletRequest request, HttpServletResponse response, HttpSession session,
            @PathVariable String usuariEntitatID) throws Exception {
    ...
    public ModelAndView desactivarUsuariEntitat(@PathVariable("usuariEntitatID") String usuariEntitatID,
    ...
    public ModelAndView activarUsuariEntitat(@PathVariable("usuariEntitatID") String usuariEntitatID,
            HttpServletRequest request, HttpServletResponse response) throws Exception {

        return activatDesactivarUsuariEntitat(usuariEntitatID, request, true);
    }

    protected ModelAndView activatDesactivarUsuariEntitat(String usuariEntitatID, HttpServletRequest request,
            boolean activar) {
        try {
            if (activar) {
    ...
    @Override
    public String getRedirectWhenModified(HttpServletRequest request, UsuariEntitatForm usuariEntitatForm,
            Throwable __e) {
    ...
    public Where getAdditionalCondition(HttpServletRequest request) throws I18NException {
        return Where.AND(ENTITATID.equal(LoginInfo.getInstance().getEntitatID()), CARREC.isNull());
    }

    @Override
    public void postValidate(HttpServletRequest request, UsuariEntitatForm usuariEntitatForm, BindingResult result)
    ...
    */
     ...
     */
    @Override
    public List<StringKeyValue> getReferenceListForPoliticaCustodia(HttpServletRequest request, ModelAndView mav,
            Where where) throws I18NException {
        return GestioEntitatAdminController
                .staticGetReferenceListForPoliticaCustodia(POLITICA_CUSTODIA.POLITICA_CUSTODIA_USUARI_ENTITAT);
    }
    ...
    @Override
    public List<StringKeyValue> getReferenceListForCustodiaInfoID(HttpServletRequest request, ModelAndView mav,
            UsuariEntitatForm configuracioForm, Where where) throws I18NException {

        Where where2 = Where.AND(where, CustodiaInfoFields.ENTITATID.equal(LoginInfo.getInstance().getEntitatID()),
