...
public class PluginFirmaWebPerUsuariEntitatAdenController extends PluginFirmaWebPerUsuariEntitatController {
    ...
    private static final String NO_USUARIENTITAT_VIEW = GestioUsuariEntitatAdenController.CONTEXTWEB
            + "/selecciousuari";
    ...
    */
    ...
    @Override
    public PluginFirmaWebPerUsuariEntitatFilterForm getPluginFirmaWebPerUsuariEntitatFilterForm(Integer pagina,
            ModelAndView mav, HttpServletRequest request) throws I18NException {

        PluginFirmaWebPerUsuariEntitatFilterForm pluginFilterForm = super.getPluginFirmaWebPerUsuariEntitatFilterForm(
                pagina, mav, request);
        ...
        if (pluginFilterForm.isNou()) {
            ...
            pluginFilterForm.addAdditionalButton(new AdditionalButton("fas fa-long-arrow-alt-left icon-white", "tornar",
                    getContextWeb() + "/tornar", AdditionalButtonStyle.PRIMARY));
    ...
    public static void mostrarAvisSegonsPolitica(HttpServletRequest request, PortaFIBBaseFilterForm pluginFilterForm,
            Integer politica) throws I18NException {
        switch (politica) {
            ...
            default:
                throw new I18NException("genapp.comodi", "Politica de PLugins de Firma Web desconeguda: " + politica);
        }
    }
    ...
    public PluginFirmaWebPerUsuariEntitatForm getPluginFirmaWebPerUsuariEntitatForm(
        ...
        PluginFirmaWebPerUsuariEntitatForm pluginForm = super.getPluginFirmaWebPerUsuariEntitatForm(_jpa, __isView,
                request, mav);
        String usuariEntitatID = (String) request.getSession().getAttribute(SESSION_USUARIENTITATID);
    ...
    * a l'usuari.
    */
    public List<StringKeyValue> getRemainingReferenceListForPluginFirmaWebID(HttpServletRequest request,
            ModelAndView mav, String usuariEntitatID) throws I18NException {

        // La llista de plugins que es poden seleccionar s'ha de filtrar addicionalment pels plugins que no estan
        // ja afegits a l'usuari, atés que el parell <usuariEntitat, plugin> és clau única.
        SubQuery<PluginFirmaWebPerUsuariEntitat, Long> subQuery = pluginFirmaWebPerUsuariEntitatEjb
                .getSubQuery(PLUGINFIRMAWEBID, USUARIENTITATID.equal(usuariEntitatID));
    ...
    */
    @Override
    public List<StringKeyValue> getReferenceListForPluginFirmaWebID(HttpServletRequest request, ModelAndView mav,
        ...
        return super.getReferenceListForPluginFirmaWebID(request, mav, Where.AND(where, wherePluginWeb, whereEntitat));
    }

    /**
    * Sobreescriu per posar etiquetes d'afegir i llevar als valors 1 i -1
    */
    public List<StringKeyValue> getReferenceListForAccio(HttpServletRequest request, ModelAndView mav, Where where)
            throws I18NException {
