...
public class FileDownloadController {
    ...
    protected static final String CONTEXTWEB_PROTECTED = "/common/arxiu/";

    protected static final String CONTEXTWEB_PUBLIC = "/public/arxiu/";
     ...
     */
    @RequestMapping(
            value = { FileDownloadController.CONTEXTWEB_PROTECTED + "{arxiuId}",
                    FileDownloadController.CONTEXTWEB_PUBLIC + "{arxiuId}" })
    public void arxiu(@PathVariable("arxiuId")
    String encryptedArxiuId, HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    public static String fileUrl(Fitxer arxiu) {
        ...
        return fileUrl(arxiu, CONTEXTWEB_PROTECTED);
    }

    public static String fileUrlPublic(Fitxer arxiu) {

        return fileUrl(arxiu, CONTEXTWEB_PUBLIC);
    }

    protected static String fileUrl(Fitxer arxiu, String contextWebBase) {
        if (arxiu == null) {
            // TODO Llançar error
            ...
            String base = contextWebBase + idfile;
