 ...
 * @author GenApp
 */
@MenuOption(labelCode="peticioDeFirma.peticioDeFirma.plural", order=230, group="WEBDB")
@Controller
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de PeticioDeFirma
   */
  @RequestMapping(value = "/cancel")
  public String cancelPeticioDeFirma(HttpServletRequest request,HttpServletResponse response) {
