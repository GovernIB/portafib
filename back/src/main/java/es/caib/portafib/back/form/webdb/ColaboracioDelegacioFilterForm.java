...
public class ColaboracioDelegacioFilterForm extends PortaFIBBaseFilterForm implements ColaboracioDelegacioFields {
  ...
  public List<Field<?>> getDefaultFilterByFields() {
    return new java.util.ArrayList<Field<?>>(Arrays.asList(new Field<?>[] { DESTINATARIID ,COLABORADORDELEGATID ,MOTIU ,DATAINICI ,DATAFI ,MOTIUDESHABILITADA }));
  }

  @Override
  public List<Field<?>> getDefaultGroupByFields() {
    return new java.util.ArrayList<Field<?>>(Arrays.asList(new Field<?>[] { ACTIVA }));
  }
