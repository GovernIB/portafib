...
public class RebreAvisController
  ...
  public String editarRebreAvisPost(@ModelAttribute RebreAvisForm rebreAvisForm,
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de RebreAvis
   */
  @RequestMapping(value = "/cancel")
  public String cancelRebreAvis(HttpServletRequest request,HttpServletResponse response) {
