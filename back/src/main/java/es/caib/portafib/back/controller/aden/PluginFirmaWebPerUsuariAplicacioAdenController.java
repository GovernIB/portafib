...
public class PluginFirmaWebPerUsuariAplicacioAdenController extends PluginFirmaWebPerUsuariAplicacioController {
    ...
    */
    ...
    @Override
    public PluginFirmaWebPerUsuariAplicacioFilterForm getPluginFirmaWebPerUsuariAplicacioFilterForm(Integer pagina,
            ModelAndView mav, HttpServletRequest request) throws I18NException {

        PluginFirmaWebPerUsuariAplicacioFilterForm pluginFilterForm = super.getPluginFirmaWebPerUsuariAplicacioFilterForm(
                pagina, mav, request);
    ...
    public PluginFirmaWebPerUsuariAplicacioForm getPluginFirmaWebPerUsuariAplicacioForm(
        ...
        PluginFirmaWebPerUsuariAplicacioForm pluginForm = super.getPluginFirmaWebPerUsuariAplicacioForm(_jpa, __isView,
                request, mav);
        String usuariAplicacioID = (String) request.getSession().getAttribute(SESSION_USUARIAPLICACIOID);
    ...
    public ModelAndView tornarEditUsuari(HttpServletRequest request, HttpServletResponse response) {
        ...
        String usuariAplicaicoID = (String) request.getSession().getAttribute(SESSION_USUARIAPLICACIOID);
    ...
    */
    public List<StringKeyValue> getRemainingReferenceListForPluginFirmaWebID(HttpServletRequest request,
            ModelAndView mav, String usuariAplicacioID) throws I18NException {

        // La llista de plugins que es poden seleccionar s'ha de filtrar addicionalment pels plugins que no estan
        // ja afegits a l'usuari, atés que el parell <usuariAplicacio, plugin> és clau única.
        SubQuery<PluginFirmaWebPerUsuariAplicacio, Long> subQuery = pluginFirmaWebPerUsuariAplicacioEjb
                .getSubQuery(PLUGINFIRMAWEBID, USUARIAPLICACIOID.equal(usuariAplicacioID));
