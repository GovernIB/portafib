...
public class TipusEstatDeFirmaInicialController
  ...
  protected List<TipusEstatDeFirmaInicial> llistat(ModelAndView mav, HttpServletRequest request,
    ...
    List<TipusEstatDeFirmaInicial> tipusEstatDeFirmaInicial = (List<TipusEstatDeFirmaInicial>) processarLlistat(tipusEstatDeFirmaInicialEjb,
  ...
  protected ModelAndView editAndViewTipusEstatDeFirmaInicialGet(@PathVariable("tipusEstatDeFirmaInicialID") java.lang.Long tipusEstatDeFirmaInicialID,
    ...
    if (tipusEstatDeFirmaInicial == null) {
      ...
      new ModelAndView(new RedirectView(getRedirectWhenCancel(tipusEstatDeFirmaInicialID), true));
  ...
  public String editarTipusEstatDeFirmaInicialPost(@ModelAttribute @Valid TipusEstatDeFirmaInicialForm tipusEstatDeFirmaInicialForm,
    ...
    try {
      ...
      log.error(msg, __e);
      return getRedirectWhenModified(tipusEstatDeFirmaInicialForm, __e);
    }
  ...
  public String eliminarTipusEstatDeFirmaInicial(@PathVariable("tipusEstatDeFirmaInicialID") java.lang.Long tipusEstatDeFirmaInicialID,
    ...
    try {
      ...
      if (tipusEstatDeFirmaInicial == null) {
        ...
        return getRedirectWhenDelete(tipusEstatDeFirmaInicialID, new Exception(__msg));
      } else {
        delete(request, tipusEstatDeFirmaInicial);
        createMessageSuccess(request, "success.deleted", tipusEstatDeFirmaInicialID);
        return getRedirectWhenDelete(tipusEstatDeFirmaInicialID,null);
      }

    } catch (Throwable e) {
      String msg = createMessageError(request, "error.deleting", tipusEstatDeFirmaInicialID, e);
      log.error(msg, e);
      return getRedirectWhenDelete(tipusEstatDeFirmaInicialID, e);
    }
  }
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  public String cancelTipusEstatDeFirmaInicial(@PathVariable("tipusEstatDeFirmaInicialID") java.lang.Long tipusEstatDeFirmaInicialID,
      HttpServletRequest request,HttpServletResponse response) {
     return getRedirectWhenCancel(tipusEstatDeFirmaInicialID);
  }
  ...
  public String getRedirectWhenCreated(TipusEstatDeFirmaInicialForm tipusEstatDeFirmaInicialForm) {
    return "redirect:" + getContextWeb() + "/list/1";
  }

  public String getRedirectWhenModified(TipusEstatDeFirmaInicialForm tipusEstatDeFirmaInicialForm, Throwable __e) {
    if (__e == null) {
  ...
  public String getRedirectWhenDelete(java.lang.Long tipusEstatDeFirmaInicialID, Throwable __e) {
    return "redirect:" + getContextWeb() + "/list";
  }

  public String getRedirectWhenCancel(java.lang.Long tipusEstatDeFirmaInicialID) {
    return "redirect:" + getContextWeb() + "/list";
  }
