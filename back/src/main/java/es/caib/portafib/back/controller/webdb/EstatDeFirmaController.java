 ...
 * @author GenApp
 */
@MenuOption(labelCode="estatDeFirma.estatDeFirma.plural", order=100, group=Tab.MENU_WEBDB)
@Controller
@RequestMapping(value = "/webdb/estatDeFirma")
@SessionAttributes(types = { EstatDeFirmaForm.class, EstatDeFirmaFilterForm.class })
@Tile(name="estatDeFirmaFormWebDB", contentJsp="/WEB-INF/jsp/webdb/estatDeFirmaForm.jsp", extendsTile=Tab.MENU_WEBDB,
      type=TileType.WEBDB_FORM , attributes={ @TileAttribute(name="titol", value="estatDeFirma.estatDeFirma")})
@Tile(name="estatDeFirmaListWebDB", contentJsp="/WEB-INF/jsp/webdb/estatDeFirmaList.jsp", extendsTile=Tab.MENU_WEBDB,
       type=TileType.WEBDB_LIST, attributes={ @TileAttribute(name="titol", value="estatDeFirma.estatDeFirma") })
public class EstatDeFirmaController
    extends es.caib.portafib.back.controller.PortaFIBBaseController<EstatDeFirma, java.lang.Long> implements EstatDeFirmaFields {

  @EJB(mappedName = es.caib.portafib.ejb.EstatDeFirmaService.JNDI_NAME)
  ...
  public Map<Field<?>, GroupByItem> fillReferencesForList(EstatDeFirmaFilterForm filterForm,
    ...
    // Field tipusEstatDeFirmaInicialID
    {
      ...
      _tmp = Utils.listToMap(_listSKV);
      filterForm.setMapOfValuesForTipusEstatDeFirmaInicialID(_tmp);
    ...
    // Field tipusEstatDeFirmaFinalID
    {
      ...
      _tmp = Utils.listToMap(_listSKV);
      filterForm.setMapOfValuesForTipusEstatDeFirmaFinalID(_tmp);
  ...
  public void exportList(@PathVariable("dataExporterID") String dataExporterID,
    ...
    __mapping.put(TIPUSESTATDEFIRMAINICIALID, filterForm.getMapOfValuesForTipusEstatDeFirmaInicialID());
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  public void initBinderForm(WebDataBinder binder) {
    ...
    initDisallowedFields(binder, "estatDeFirma.estatDeFirmaID");
  }
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de EstatDeFirma
   */
  @RequestMapping(value = "/cancel")
  public String cancelEstatDeFirma(HttpServletRequest request,HttpServletResponse response) {
  ...
  public void delete(HttpServletRequest request, EstatDeFirma estatDeFirma) throws I18NException {
