...
public abstract class AbstractPeticioDeFirmaByTipusSolicitant extends AbstractPeticioDeFirmaController
    ...
    public String afegirCustodia(HttpServletRequest request, HttpServletResponse response,
        ...
        I18NTranslation messageTranslation = new I18NTranslation("success.creation",
                new I18NArgumentCode("custodiaInfo.custodiaInfo"), new I18NArgumentCode("custodiaInfo.custodiaInfoID"),
        ...
        return "redirect:" + getCustodiaContext() + "/" + custodiaInfo.getCustodiaInfoID() + "/edit";
    }
    ...
    public String gestioAnnexes(HttpServletRequest request, HttpServletResponse response,
        ...
        request.getSession().setAttribute(AbstractAnnexController.PETICIO_DE_FIRMA_FOR_ANNEX_MANAGEMENT,
                peticioDeFirmaID);
    ...
    public String pausar(HttpServletRequest request, HttpServletResponse response, @PathVariable long peticioDeFirmaID)
            throws I18NException {
    ...
    public String revisat(HttpServletRequest request, HttpServletResponse response, @PathVariable Long peticioDeFirmaID)
            throws I18NException {
    ...
    public String clonarPeticio(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            peticio = this.peticioDeFirmaLogicaEjb.clonePeticioDeFirma(peticioDeFirmaID,
                    LoginInfo.getInstance().getEntitat(), I18NUtils.tradueix("copiade"));
    ...
    public String reinicialitzarPeticio(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            if (e instanceof I18NException) {
                ...
                log.error("Error desconegut al reinicialitzar la peticio " + peticioDeFirmaID + " :" + e.getMessage(),
                        e);
    ...
    protected void delete(HttpServletRequest request, Long peticioDeFirmaID) throws Exception, I18NException {
    ...
    public void delete(HttpServletRequest request, PeticioDeFirma peticioDeFirma) throws I18NException {
        ...
        if (getTipusSolicitant() == TipusSolicitant.SOLICITANT_WEB) {
            ...
            Set<Long> fitxers = peticioDeFirmaLogicaEjb.deleteFullUsingAdministradorEntitat(
                    peticioDeFirma.getPeticioDeFirmaID(),
                    LoginInfo.getInstance().getUsuariPersona().getUsuariPersonaID(), motiuEsborrat);
            borrarFitxers(fitxers);
        }
    ...
    public String rebutjarSeleccionades(HttpServletRequest request, HttpServletResponse response,
            @ModelAttribute PeticioDeFirmaFilterForm filterForm) {
            ...
            switch (tipusSolicitant) {
                case SOLICITANT_WEB:
                    ordre = new OrderBy[] {
                            ...
                            new OrderBy(DATAFINAL, OrderType.DESC), new OrderBy(DATASOLICITUD, OrderType.DESC), };
                break;
            ...
            switch (getTipusSolicitant()) {
                ...
                case SOLICITANT_APLICACIO:
                    ...
                    peticioDeFirma.setRemitentNom(
                            Utils.getOnlyNom(loginInfo.getUsuariPersona()) + " (" + usuariAplicacioID + ")");
    ...
    public List<StringKeyValue> getReferenceListForTipusDocumentID(HttpServletRequest request, ModelAndView mav,
        ...
        result = super.getReferenceListForTipusDocumentID(request, mav, peticioDeFirmaForm, Where.AND(where, whereTD));
    ...
    public Where getAdditionalCondition(HttpServletRequest request) throws I18NException {
        ...
        switch (getTipusSolicitant()) {
            ...
            case SOLICITANT_WEB:
                ...
                return Where.AND(SOLICITANTUSUARIENTITAT1ID.equal(LoginInfo.getInstance().getUsuariEntitatID()),
            ...
            case SOLICITANT_APLICACIO:
                ...
                return Where.AND(ORIGENPETICIODEFIRMA.notEqual(ORIGEN_PETICIO_DE_FIRMA_SOLICITANT_WEB),
            ...
            case SOLICITANT_TOTS:
                ...
                SubQuery<UsuariAplicacio, String> subqueryApp = usuariAplicacioEjb.getSubQuery(
    ...
    public void postList(HttpServletRequest request, ModelAndView mav, PeticioDeFirmaFilterForm filterForm,
        ...
        switch (tipusSolicitant) {
            ...
            case SOLICITANT_WEB: {
                ...
                politicaCustodia = custodiaInfoLogicaEjb.getPoliticaDeCustodiaFinalPerUE(usuariEntitat, entitat);
            ...
            case SOLICITANT_TOTS: {
                // Administrador d'Entitat - USUARI APLICACIO
                {
                    ...
                    List<String> _listSKV = usuariAplicacioEjb.executeQuery(UsuariAplicacioFields.USUARIAPLICACIOID,
                            Where.AND(w1, w2));
                ...
                switch (peticio.getOrigenPeticioDeFirma()) {
                    ...
                    default:
                        ...
                        HtmlUtils.saveMessageError(request,
                                "No hi ha codi per el PostList de les Peticions de Firma amb Origen " + I18NUtils
                                        .tradueix("origenpeticiodefirma." + peticio.getOrigenPeticioDeFirma()));
                }
        ...
        for (PeticioDeFirma pf : list) {
            ...
            if (avisweb) {
                ...
                filterForm.addAdditionalButtonByPK(peticioDeFirmaID,
                        new AdditionalButton("far fa-check-square icon-white", "revisat",
                                getContextWeb() + "/revisat/" + peticioDeFirmaID, AdditionalButtonStyle.WARNING));
            }

            /* VEURE DOC */
            filterForm.addAdditionalButtonByPK(peticioDeFirmaID,
                    new AdditionalButton("far fa-file icon-white", "veuredoc",
                            // getContextWeb() + "/docfirmat/" + peticioDeFirmaID,
                            "javascript:var win = window.open('" + request.getContextPath() + getContextWeb()
                                    + "/docfirmat/" + peticioDeFirmaID + "', '_blank'); win.focus();",
                            AdditionalButtonStyle.INFO));

            /* DESCARREGAR DOC */
            filterForm.addAdditionalButtonByPK(peticioDeFirmaID,
                    new AdditionalButton("fas fa-download icon-white", "descarregardoc",
                            // getContextWeb() + "/docfirmat/" + peticioDeFirmaID,
                            "javascript:var win = window.open('" + request.getContextPath() + getContextWeb()
            ...
            if (estat == ConstantsV2.TIPUSESTATPETICIODEFIRMA_NOINICIAT && !isNomesConsulta()) {
                ...
                filterForm.addAdditionalButtonByPK(peticioDeFirmaID, new AdditionalButton(
                        "fas fa-pencil-alt icon-white", "peticiodefirma.editar", "javascript:goTo('"
                                + request.getContextPath() + getContextWeb() + "/" + peticioDeFirmaID + "/edit')",
                ...
                /* FLUXDEFIRMES */
                filterForm.addAdditionalButtonByPK(peticioDeFirmaID,
                        new AdditionalButton("fas fa-eye icon-white", "peticiodefirma.veuredetalls",
                                getContextWeb() + "/" + peticioDeFirmaID + "/edit", AdditionalButtonStyle.INFO));

                filterForm
                        .addAdditionalButtonByPK(peticioDeFirmaID,
                                new AdditionalButton("/img/fluxicon.png", "fluxDeFirmes.fluxDeFirmes",
                                        getFluxPath() + "/view/" + peticioDeFirma.getFluxDeFirmesID()
            ...
            // ANNEXES
            {
                AdditionalButtonStyle type;
                if (estat == ConstantsV2.TIPUSESTATPETICIODEFIRMA_NOINICIAT) {
                    type = AdditionalButtonStyle.WARNING;
                } else {
                    type = AdditionalButtonStyle.INFO;
                }

                // Afegim Boto de gestió d'Annexes
                filterForm.addAdditionalButtonByPK(peticioDeFirmaID, new AdditionalButton("icon-white far fa-file",
                        "annex.annex.plural", getContextWeb() + "/gestioannexes/{0}", type));
            }
                    ...
                    if (estat == ConstantsV2.TIPUSESTATPETICIODEFIRMA_NOINICIAT) {
                        if (peticioDeFirma.getCustodiaInfoID() == null) {
                            ...
                            if (pc == null) {
                                ...
                                if (peticioDeFirma
                                        .getOrigenPeticioDeFirma() == ORIGEN_PETICIO_DE_FIRMA_SOLICITANT_WEB) {
                            ...
                            if (!isNomesConsulta()) {
                                filterForm.addAdditionalButtonByPK(peticioDeFirmaID,
                                        new AdditionalButton("/img/custodia.png", "custodia.modificar",
                                                getContextWeb() + "/editarcustodiainfo/"
                                                        + peticioDeFirma.getCustodiaInfoID(),
                                                AdditionalButtonStyle.WARNING));
                            }
                    ...
                    filterForm.addAdditionalButtonByPK(peticioDeFirmaID,
                            new AdditionalButton(
                                    "fas fa-play icon-white", "iniciar", "javascript:goTo('" + request.getContextPath()
                                            + getContextWeb() + "/iniciar/" + peticioDeFirmaID + "')",
                    ...
                    filterForm.addAdditionalButtonByPK(peticioDeFirmaID,
                            new AdditionalButton(
                                    "fas fa-pause icon-white", "pausar", "javascript:goTo('" + request.getContextPath()
                                            + getContextWeb() + "/pausar/" + peticioDeFirmaID + "')",
                                    AdditionalButtonStyle.WARNING));
                ...
                if (estat == ConstantsV2.TIPUSESTATPETICIODEFIRMA_ENPROCES
                    ...
                    filterForm.addAdditionalButtonByPK(peticioDeFirmaID,
                            new AdditionalButton("fas fa-times", "rebutjar",
                                    "javascript:rebutjar(" + peticioDeFirmaID + ");", AdditionalButtonStyle.WARNING));
                }
            }
                        ...
                        filterForm.addAdditionalButtonByPK(peticioDeFirmaID,
                                new AdditionalButton("fas fa-redo icon-white", "reinicialitzar",
                                        "javascript:goTo('" + request.getContextPath() + getContextWeb()
                                                + "/reinicialitzar/" + peticioDeFirmaID + "')",
            ...
            if (!isNomesConsulta()) {
                if (tipusSolicitant == TipusSolicitant.SOLICITANT_WEB) {
                    ...
                    if (estat == ConstantsV2.TIPUSESTATPETICIODEFIRMA_ENPROCES
                        ...
                        filterForm.addAdditionalButtonByPK(peticioDeFirmaID,
                                new AdditionalButton("fas fa-trash icon-white", "genapp.delete",
                                        "javascript:rebutjarEsborrar(" + peticioDeFirmaID + ");",
                                        AdditionalButtonStyle.DANGER));
                    } else {
                        filterForm.addAdditionalButtonByPK(peticioDeFirmaID,
                                new AdditionalButton("fas fa-trash icon-white", "genapp.delete",
                                        "javascript:esborrarAmbMotiu(" + peticioDeFirmaID + ");",
                                        AdditionalButtonStyle.DANGER));
                    }
                    deleteCount++;
                }
        ...
        if (deleteMultiple || pausarMultiple || marcarRevisat || downloadMassiu || noIniciatMultiple || reiniciable
                || mostrarBotoGlobalRebutjar || fitxersOriginals || fitxersAdaptats) {

            filterForm.setVisibleMultipleSelection(true);

            if (mostrarBotoGlobalRebutjar) {
                filterForm.addAdditionalButton(new AdditionalButton("fas fa-times", "rebutjar",
                        "javascript:rebutjarseleccionades();", AdditionalButtonStyle.WARNING));
            }
            ...
            if (deleteMultiple) {
                ...
                if (tipusSolicitant == TipusSolicitant.SOLICITANT_WEB) {
                    ...
                    filterForm.addAdditionalButton(new AdditionalButton("fas fa-trash icon-white", "genapp.delete",
                            "javascript:esborrarAmbMotiuSeleccionades();", AdditionalButtonStyle.DANGER));
                }
            } else {
                filterForm.setDeleteSelectedButtonVisible(false);
            }
            ...
            if (pausarMultiple) {
                filterForm.addAdditionalButton(new AdditionalButton(
                        "fas fa-pause icon-white", "pausar", "javascript:submitTo('peticioDeFirmaFilterForm'," + " '"
                                + request.getContextPath() + getContextWeb() + "/pausarseleccionats');",
                        AdditionalButtonStyle.WARNING));
            }

            if (downloadMassiu) {
                filterForm.addAdditionalButton(new AdditionalButton("fas fa-download icon-white", "descarregar.firmes",
                        "javascript:submitTo('peticioDeFirmaFilterForm'," + " '" + request.getContextPath()
                                + getContextWeb() + "/downloadseleccionats');",
                        AdditionalButtonStyle.SUCCESS));
            }

            if (reiniciable) {
                filterForm.addAdditionalButton(new AdditionalButton(
                        "fas fa-redo icon-white", "reinicialitzar", "javascript:submitTo('peticioDeFirmaFilterForm',"
            ...
            if (marcarRevisat) {
                filterForm.addAdditionalButton(new AdditionalButton(
                        "far fa-check-square icon-white", "revisat", "javascript:submitTo('peticioDeFirmaFilterForm',"
            ...
            if (noIniciatMultiple) {
                filterForm.addAdditionalButton(new AdditionalButton(
                        "fas fa-play icon-white", "iniciar", "javascript:submitTo('peticioDeFirmaFilterForm','"
                                + request.getContextPath() + getContextWeb() + "/iniciarseleccionats')",
                        AdditionalButtonStyle.SUCCESS));
            }

            // FITXERS ADAPTATS I ORIGINALS 
            if (fitxersOriginals || fitxersAdaptats) {
                HtmlUtils.saveMessageInfo(request, I18NUtils.tradueix("peticiodefirma.netejaesborrat.ajuda"));
            }
            ...
            if (fitxersAdaptats) {
                if (!isNomesConsulta()) {
                    filterForm
                            .addAdditionalButton(
                                    new AdditionalButton("fas fa-broom icon-white",
                                            "peticiodefirma.netejaesborrat.netejaradaptat",
                                            "javascript:submitTo('peticioDeFirmaFilterForm'," + " '"
                                                    + request.getContextPath() + getContextWeb() + "/netejarAdaptat');",
                                            AdditionalButtonStyle.WARNING));
                }
        ...
        if (!isNomesConsulta() && addCreateButton()) {
            ...
            filterForm.addAdditionalButton(new AdditionalButton("fas fa-plus-circle", "peticiodefirma.crear", action,
                    AdditionalButtonStyle.SECONDARY));
        }
            ...
            case ORIGEN_PETICIO_DE_FIRMA_API_FIRMA_ASYNC_SIMPLE_V2:
                ...
                if (peticioDeFirmaForm.getPeticioDeFirma().getConfiguracioDeFirmaID() == null) {
                    result.rejectValue(get(CONFIGURACIODEFIRMAID), "genapp.validation.required",
                            new Object[] { I18NUtils.tradueix(CONFIGURACIODEFIRMAID.fullName) }, "Camp Requerit");
                }
            break;
