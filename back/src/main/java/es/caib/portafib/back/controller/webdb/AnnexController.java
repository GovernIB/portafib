 ...
 * @author GenApp
 */
@MenuOption(labelCode="annex.annex.plural", order=0, group=Tab.MENU_WEBDB)
@Controller
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de Annex
   */
  @RequestMapping(value = "/cancel")
  public String cancelAnnex(HttpServletRequest request,HttpServletResponse response) {
