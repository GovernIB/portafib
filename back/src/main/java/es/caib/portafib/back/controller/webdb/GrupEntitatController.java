 ...
 * @author GenApp
 */
@MenuOption(labelCode="grupEntitat.grupEntitat.plural", order=140, group=Tab.MENU_WEBDB)
@Controller
...
public class GrupEntitatController
  ...
  public String editarGrupEntitatPost(@ModelAttribute GrupEntitatForm grupEntitatForm,
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de GrupEntitat
   */
  @RequestMapping(value = "/cancel")
  public String cancelGrupEntitat(HttpServletRequest request,HttpServletResponse response) {
