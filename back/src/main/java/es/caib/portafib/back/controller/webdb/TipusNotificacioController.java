 ...
 * @author GenApp
 */
@MenuOption(labelCode="tipusNotificacio.tipusNotificacio.plural", order=370, group=Tab.MENU_WEBDB)
@Controller
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de TipusNotificacio
   */
  @RequestMapping(value = "/cancel")
  public String cancelTipusNotificacio(HttpServletRequest request,HttpServletResponse response) {
  ...
  public void delete(HttpServletRequest request, TipusNotificacio tipusNotificacio) throws I18NException {
