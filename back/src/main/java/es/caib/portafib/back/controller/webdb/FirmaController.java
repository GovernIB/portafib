 ...
 * @author GenApp
 */
@MenuOption(labelCode="firma.firma.plural", order=110, group=Tab.MENU_WEBDB)
@Controller
...
public class FirmaController
  ...
  public String editarFirmaPost(@ModelAttribute FirmaForm firmaForm,
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de Firma
   */
  @RequestMapping(value = "/cancel")
  public String cancelFirma(HttpServletRequest request,HttpServletResponse response) {
  ...
  public void delete(HttpServletRequest request, Firma firma) throws I18NException {
