 ...
 * @author GenApp
 */
@MenuOption(labelCode="blocDeFirmes.blocDeFirmes.plural", order=30, group=Tab.MENU_WEBDB)
@Controller
@RequestMapping(value = "/webdb/blocDeFirmes")
@SessionAttributes(types = { BlocDeFirmesForm.class, BlocDeFirmesFilterForm.class })
@Tile(name="blocDeFirmesFormWebDB", contentJsp="/WEB-INF/jsp/webdb/blocDeFirmesForm.jsp", extendsTile=Tab.MENU_WEBDB,
      type=TileType.WEBDB_FORM , attributes={ @TileAttribute(name="titol", value="blocDeFirmes.blocDeFirmes")})
@Tile(name="blocDeFirmesListWebDB", contentJsp="/WEB-INF/jsp/webdb/blocDeFirmesList.jsp", extendsTile=Tab.MENU_WEBDB,
       type=TileType.WEBDB_LIST, attributes={ @TileAttribute(name="titol", value="blocDeFirmes.blocDeFirmes") })
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de BlocDeFirmes
   */
  @RequestMapping(value = "/cancel")
  public String cancelBlocDeFirmes(HttpServletRequest request,HttpServletResponse response) {
