  ...
  <div id="nouUsuariAlGrup" class="modal hide fade">
    ...
    <div class="modal-body">
      &nbsp;<fmt:message key="form.titol.nifusername"></fmt:message>:&nbsp; <input id="userToAdd" name="userToAdd" type="text" value="">
    </div>
    <div class="modal-footer">
      <button type="button" class="btn btn-primary" onclick="addUserToGroup()" title="<fmt:message key="afegir" />" >
