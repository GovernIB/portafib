        ...
        <tr>
          <td>
            ...
            <td>
              ...
              <form:textarea rows="3" readonly="${ gen:contains(__theForm.readOnlyFields ,ColaboracioDelegacioFields.DESCRIPCIO)? 'true' : 'false'}" cssClass="${gen:contains(__theForm.readOnlyFields ,ColaboracioDelegacioFields.DESCRIPCIO)? 'input-xxlarge uneditable-input' : 'input-xxlarge'}"   path="colaboracioDelegacio.descripcio"  />
           </td>
        </tr>
        </c:if>
        ...
        <tr>
          <td>
            ...
            <td>
              ...
              <form:textarea rows="3" readonly="${ gen:contains(__theForm.readOnlyFields ,ColaboracioDelegacioFields.MOTIUDESHABILITADA)? 'true' : 'false'}" cssClass="${gen:contains(__theForm.readOnlyFields ,ColaboracioDelegacioFields.MOTIUDESHABILITADA)? 'input-xxlarge uneditable-input' : 'input-xxlarge'}"   path="colaboracioDelegacio.motiuDeshabilitada"  />
           </td>
        </tr>
        </c:if>
