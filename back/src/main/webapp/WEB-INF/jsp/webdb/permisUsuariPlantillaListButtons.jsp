...
<%@ include file="/WEB-INF/jsp/moduls/includes.jsp"%>
      ...
      <ul class="dropdown-menu pull-right" style="min-width:35px;padding:5px 5px 0px 5px;margin:0px;font-size: 12px" >
            <c:if test="${__theFilterForm.editButtonVisible}">
            <li>
            <a class="btn  btn-small a_item" style="margin-bottom:5px;" href="<c:url value="${contexte}/${permisUsuariPlantilla.permisUsuariPlantillaID}/edit"/>" onclick="goTo('<c:url value="${contexte}/${permisUsuariPlantilla.permisUsuariPlantillaID}/edit"/>')">
            <i class="icon-pencil"></i>
            ...
            <c:if test="${__theFilterForm.deleteButtonVisible}">
            <li>
            <a class="btn btn-danger btn-small a_item" style="margin-bottom:5px;color: white;" href="#myModal" onclick="openModal('<c:url value="${contexte}/${permisUsuariPlantilla.permisUsuariPlantillaID}/delete"/>','show');">
            <i class="icon-trash icon-white"></i>
