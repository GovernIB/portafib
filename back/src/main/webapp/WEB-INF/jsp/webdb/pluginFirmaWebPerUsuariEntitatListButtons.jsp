...
<%@ include file="/WEB-INF/jsp/moduls/includes.jsp"%>
          ...
          <c:choose>
           <c:when test="${__theFilterForm.actionsRenderer == 1}">
            ...
            <a class="btn btn-info" href="<c:url value="${contexte}/view/${pluginFirmaWebPerUsuariEntitat.pluginFirmaWebPerUsrEntID}"/>" role="button"  title="<fmt:message key="genapp.view"/>">
