...
<%@ include file="/WEB-INF/jsp/moduls/includes.jsp"%>
          ...
          <c:choose>
           <c:when test="${__theFilterForm.actionsRenderer == 1}">
            ...
            <a class="btn " href="#"
               onclick="goTo('<c:url value="${contexte}/${grupEntitatUsuariEntitat.grupEntitatUsuariEntitatID}/edit"/>')"
            ...
            <a class="btn btn-danger" href="#myModal"
               onclick="openModal('<c:url value="${contexte}/${grupEntitatUsuariEntitat.grupEntitatUsuariEntitatID}/delete"/>','show');"
