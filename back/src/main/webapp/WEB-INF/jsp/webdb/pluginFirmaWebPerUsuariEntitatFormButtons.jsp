...
<%@ include file="/WEB-INF/jsp/moduls/includes.jsp"%>
  ...
  <div class="navbar-form float-right">
    ...
    <input type="button" class="btn" onclick="goTo('<c:url value="${contexte}/${__theForm.pluginFirmaWebPerUsuariEntitat.pluginFirmaWebPerUsrEntID}/cancel"/>')" value="<fmt:message key="genapp.cancel"/>">
    </c:if>
