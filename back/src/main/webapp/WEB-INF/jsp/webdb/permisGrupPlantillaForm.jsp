...
<form:form modelAttribute="permisGrupPlantillaForm" method="${(empty method)?'post':method}"
  ...
  <c:if test="${not empty permisGrupPlantillaForm.sections}">
     <c:set var="__basename" value="permisGrupPlantilla" scope="page" />
