...
<div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
  ...
  <input id="${__entry.value.searchBy.fullName}" name="${__entry.value.searchBy.fullName}" class="search-query input-medium" placeholder="${cercaperAF}" type="text" value="${__entry.value.searchByValue}"/>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,RoleUsuariEntitatFields.ID)}">
            <%-- FILTRE NUMERO --%>      
            <div class="input-prepend input-append" style="padding-right: 4px;padding-bottom: 4px;">
              <span class="add-on"><fmt:message key="roleUsuariEntitat.id" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,RoleUsuariEntitatFields.ROLEID)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="roleUsuariEntitat.roleID" var="roleID" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,RoleUsuariEntitatFields.USUARIENTITATID)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="roleUsuariEntitat.usuariEntitatID" var="usuariEntitatID" />
