...
<un:useConstants var="RoleFields" className="es.caib.portafib.model.fields.RoleFields"/>
  ...
  <c:set var="__theForm" value="${roleForm}"/>
  ...
  <div class="module_content">
    ...
    <table id="role_tableid" class="tdformlabel table-sm table table-bordered table-striped marTop10 table-genapp table-genapp-form" > 
    <tbody>      
