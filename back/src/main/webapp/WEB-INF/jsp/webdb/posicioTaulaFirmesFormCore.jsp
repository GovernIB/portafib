...
<un:useConstants var="PosicioTaulaFirmesFields" className="es.caib.portafib.model.fields.PosicioTaulaFirmesFields"/>
        ...
        <tr id="posicioTaulaFirmes_posicioTaulaFirmesID_rowid">
          <td>
            <label>
        ...
        <tr id="posicioTaulaFirmes_nom_rowid">
          <td>
            <label>
        ...
        <tr id="posicioTaulaFirmes_descripcio_rowid">
          <td>
            <label>
            ...
            <td>
              ...
              <ul class="dropdown-menu">
                <li><a href="#" onclick="javascript:var ta=document.getElementById('posicioTaulaFirmes.descripcio'); ta.wrap='off';" >No Wrap</a></li>
                <li><a href="#" onclick="javascript:var ta=document.getElementById('posicioTaulaFirmes.descripcio'); ta.wrap='soft';">Soft Wrap</a></li>
                <li><a href="#" onclick="javascript:var ta=document.getElementById('posicioTaulaFirmes.descripcio'); ta.wrap='hard';">Hard Wrap</a></li>
              </ul>
              </div>
           </td>
        </tr>
        ...
        <tr id="posicioTaulaFirmes_suportada_rowid">
          <td>
            <label>
