        ...
        <tr>
          <td>
            ...
            <td>
              ...
              <form:textarea rows="3" wrap="off" style="overflow:auto;" cssClass="input-xxlarge" readonly="${ gen:contains(__theForm.readOnlyFields ,PosicioTaulaFirmesFields.DESCRIPCIO)? 'true' : 'false'}" path="posicioTaulaFirmes.descripcio"  />
           </td>
        </tr>
        </c:if>
