        ...
        <tr>
          <td>
            ...
            <td>
              ...
              <form:textarea rows="3" readonly="${ gen:contains(__theForm.readOnlyFields ,PosicioTaulaFirmesFields.DESCRIPCIO)? 'true' : 'false'}" cssClass="${gen:contains(__theForm.readOnlyFields ,PosicioTaulaFirmesFields.DESCRIPCIO)? 'input-xxlarge uneditable-input' : 'input-xxlarge'}"   path="posicioTaulaFirmes.descripcio"  />
           </td>
        </tr>
        </c:if>
