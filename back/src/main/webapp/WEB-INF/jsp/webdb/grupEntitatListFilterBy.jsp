...
<un:useConstants var="GrupEntitatFields" className="es.caib.portafib.model.fields.GrupEntitatFields"/>
  ...
  <div id="FilterDiv" class="well formbox" style="${displayFilterDiv} margin-bottom:3px; margin-left: 1px; padding:3px;">
      ...
      <div class="input-prepend input-append" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,GrupEntitatFields.GRUPENTITATID)}">
            <%-- FILTRE NUMERO --%>      
            <div class="input-prepend input-append" style="padding-right: 4px;padding-bottom: 4px;">
              <span class="add-on"><fmt:message key="grupEntitat.grupEntitatID" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,GrupEntitatFields.NOM)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="grupEntitat.nom" var="nom" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,GrupEntitatFields.DESCRIPCIO)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="grupEntitat.descripcio" var="descripcio" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,GrupEntitatFields.ENTITATID)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="grupEntitat.entitatID" var="entitatID" />
