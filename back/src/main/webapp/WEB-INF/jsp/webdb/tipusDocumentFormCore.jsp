...
<un:useConstants var="TipusDocumentFields" className="es.caib.portafib.model.fields.TipusDocumentFields"/>
        ...
        <tr id="tipusDocument_tipusDocumentID_rowid">
          <td>
            ...
            <form:input readonly="${ gen:contains(__theForm.readOnlyFields ,TipusDocumentFields.TIPUSDOCUMENTID)? 'true' : 'false'}" cssClass="form-control ${gen:contains(__theForm.readOnlyFields ,TipusDocumentFields.TIPUSDOCUMENTID)? ' uneditable-input' : ''}"  style=""  path="tipusDocument.tipusDocumentID"   />
       ...
       <div class="row-fluid  col-md-8">
        ...
        <tr id="tipusDocument_tipusDocumentBaseID_rowid">
          ...
          <input type="text" readonly="true" class="form-control input-xxlarge uneditable-input" value="${gen:findValue(__theForm.tipusDocument.tipusDocumentBaseID,__theForm.listOfValuesForTipusDocumentBaseID)}"  />
          </c:if>
          <c:if test="${!gen:contains(__theForm.readOnlyFields ,TipusDocumentFields.TIPUSDOCUMENTBASEID)}" >
          <c:set var="containEmptyValue"  value="false" />
          <form:select id="tipusDocument_tipusDocumentBaseID"  onchange="if(typeof onChangeTipusDocumentBaseID == 'function') {  onChangeTipusDocumentBaseID(this); };"  cssClass="form-control col-md-8" path="tipusDocument.tipusDocumentBaseID">
        ...
        <tr id="tipusDocument_descripcio_rowid">
          <td>
            ...
            <td>
              ...
              <form:textarea rows="3" wrap="soft" style="overflow:auto;display: inline;resize:both;max-width:90%;" cssClass="form-control " readonly="${ gen:contains(__theForm.readOnlyFields ,TipusDocumentFields.DESCRIPCIO)? 'true' : 'false'}" path="tipusDocument.descripcio"  />
      ...
      <script type="text/javascript">
        ...
        <tr id="tipusDocument_usuariAplicacioID_rowid">
          ...
          <input type="text" readonly="true" class="form-control input-xxlarge uneditable-input" value="${gen:findValue(__theForm.tipusDocument.usuariAplicacioID,__theForm.listOfUsuariAplicacioForUsuariAplicacioID)}"  />
          </c:if>
          <c:if test="${!gen:contains(__theForm.readOnlyFields ,TipusDocumentFields.USUARIAPLICACIOID)}" >
          <c:set var="containEmptyValue"  value="false" />
          <form:select id="tipusDocument_usuariAplicacioID"  onchange="if(typeof onChangeUsuariAplicacioID == 'function') {  onChangeUsuariAplicacioID(this); };"  cssClass="form-control col-md-8" path="tipusDocument.usuariAplicacioID">
