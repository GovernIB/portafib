...
<div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
  ...
  <input id="${__entry.value.searchBy.fullName}" name="${__entry.value.searchBy.fullName}" class="search-query input-medium" placeholder="${cercaperAF}" type="text" value="${__entry.value.searchByValue}"/>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,PosicioTaulaFirmesFields.POSICIOTAULAFIRMESID)}">
            <%-- FILTRE NUMERO --%>      
            <div class="input-prepend input-append" style="padding-right: 4px;padding-bottom: 4px;">
              <span class="add-on"><fmt:message key="posicioTaulaFirmes.posicioTaulaFirmesID" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,PosicioTaulaFirmesFields.NOM)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="posicioTaulaFirmes.nom" var="nom" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,PosicioTaulaFirmesFields.DESCRIPCIO)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="posicioTaulaFirmes.descripcio" var="descripcio" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,PosicioTaulaFirmesFields.SUPORTADA)}">
            <%-- FILTRE NUMERO --%>      
            <div class="input-prepend input-append" style="padding-right: 4px;padding-bottom: 4px;">
              <span class="add-on"><fmt:message key="posicioTaulaFirmes.suportada" />:</span>

              <span class="add-on"><fmt:message key="genapp.from" /></span>
              
              <form:input cssClass="input-append input-small" path="suportadaDesde" />
                                       
              
              <span class="add-on"><fmt:message key="genapp.to" /></span>
              
              <form:input cssClass="input-append input-small search-query" path="suportadaFins" />
