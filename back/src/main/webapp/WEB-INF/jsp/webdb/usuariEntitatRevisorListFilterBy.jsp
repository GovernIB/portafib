...
<un:useConstants var="UsuariEntitatRevisorFields" className="es.caib.portafib.model.fields.UsuariEntitatRevisorFields"/>
  ...
  <div id="FilterDiv" class="well formbox" style="${displayFilterDiv} margin-bottom:3px; margin-left: 1px; padding:3px;">
      ...
      <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,UsuariEntitatRevisorFields.USUARIENTITATREVISORID)}">
            <%-- FILTRE NUMERO --%>      
            <div class="input-prepend input-append" style="padding-right: 4px;padding-bottom: 4px;">
              <span class="add-on"><fmt:message key="usuariEntitatRevisor.usuariEntitatRevisorId" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,UsuariEntitatRevisorFields.USUARIENTITATID)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="usuariEntitatRevisor.usuariEntitatID" var="usuariEntitatID" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,UsuariEntitatRevisorFields.ACTIU)}">
            <%-- FILTRE NUMERO --%>      
            <div class="input-prepend input-append" style="padding-right: 4px;padding-bottom: 4px;">
              <span class="add-on"><fmt:message key="usuariEntitatRevisor.actiu" />:</span>
