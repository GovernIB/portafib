...
<un:useConstants var="TipusNotificacioFields" className="es.caib.portafib.model.fields.TipusNotificacioFields"/>
  ...
  <div id="FilterDiv" class="well formbox" style="${displayFilterDiv} margin-bottom:3px; margin-left: 1px; padding:3px;">
      ...
      <div class="form-inline">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,TipusNotificacioFields.TIPUSNOTIFICACIOID)}">
            <%-- FILTRE NUMERO --%>      
            <div class="input-prepend input-append" style="padding-right: 4px;padding-bottom: 4px;">
              <span class="add-on"><fmt:message key="tipusNotificacio.tipusNotificacioID" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,TipusNotificacioFields.NOM)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="tipusNotificacio.nom" var="nom" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,TipusNotificacioFields.DESCRIPCIO)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="tipusNotificacio.descripcio" var="descripcio" />
