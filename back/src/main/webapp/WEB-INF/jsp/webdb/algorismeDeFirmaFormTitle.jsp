...
<div class="lead" style="margin-bottom:10px">
 <c:choose>
  <c:when test="${fn:startsWith(algorismeDeFirmaForm.titleCode,'=')}">
       <c:out value="${fn:substringAfter(algorismeDeFirmaForm.titleCode, '=')}" escapeXml="false"/>
  </c:when>
  <c:when test="${not empty algorismeDeFirmaForm.titleCode}">
