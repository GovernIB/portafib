...
<%@ include file="/WEB-INF/jsp/moduls/includes.jsp"%>
  ...
  <div class="navbar-form pull-right">
    ...
    <input type="button" class="btn" onclick="goTo('<c:url value="${contexte}/${__theForm.grupEntitat.grupEntitatID}/cancel"/>')" value="<fmt:message key="genapp.cancel"/>">
    </c:if>
    ...
    <c:set var="pk" value="${__theForm.grupEntitat.grupEntitatID}"/>
