...
<%@ include file="/WEB-INF/jsp/moduls/includes.jsp"%>
          ...
          <td>
            ...
            <a class="btn" href="#" 
              onclick="goTo('<c:url value="${contexte}/${tipusEstatDeFirmaInicial.tipusEstatDeFirmaInicialID}/edit"/>')"
            ...
            <a class="btn btn-danger" href="#myModal"
               onclick="openModal('<c:url value="${contexte}/${tipusEstatDeFirmaInicial.tipusEstatDeFirmaInicialID}/delete"/>','show');"
