...
<div class="lead" style="margin-bottom:10px">
 <c:choose>
  <c:when test="${fn:startsWith(bitacolaForm.titleCode,'=')}">
       <c:out value="${fn:substringAfter(bitacolaForm.titleCode, '=')}" escapeXml="false"/>
  </c:when>
  <c:when test="${not empty bitacolaForm.titleCode}">
