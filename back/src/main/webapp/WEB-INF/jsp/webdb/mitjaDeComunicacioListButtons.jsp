...
<%@ include file="/WEB-INF/jsp/moduls/includes.jsp"%>
          ...
          <td>
            ...
            <a class="btn" href="#" 
              onclick="goTo('<c:url value="${contexte}/${mitjaDeComunicacio.mitjaDeComunicacioID}/edit"/>')"
            ...
            <a class="btn btn-danger" href="#myModal"
               onclick="openModal('<c:url value="${contexte}/${mitjaDeComunicacio.mitjaDeComunicacioID}/delete"/>','show');"
               title="<fmt:message key="genapp.delete"/>">
               <i class="icon-trash icon-white"></i>
            </a>
            </c:if>
            <c:set var="bracket" value="{0}"/>
            <c:set var="pk" value="${mitjaDeComunicacio.mitjaDeComunicacioID}"/>
