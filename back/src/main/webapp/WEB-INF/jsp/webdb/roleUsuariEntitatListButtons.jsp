...
<%@ include file="/WEB-INF/jsp/moduls/includes.jsp"%>
          ...
          <c:choose>
           <c:when test="${__theFilterForm.actionsRenderer == 1}">
            ...
            <a class="btn " href="<c:url value="${contexte}/${roleUsuariEntitat.id}/edit"/>" onclick="goTo('<c:url value="${contexte}/${roleUsuariEntitat.id}/edit"/>')" title="<fmt:message key="genapp.edit"/>">
