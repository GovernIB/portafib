  ...
  <div class="module_content">
    ...
    <c:if test="${not __theForm.view}">    <c:forEach items="${__theForm.hiddenFields}" var="hiddenFieldF" >
      ...
      <c:if test="${gen:hasProperty(__theForm.colaboracioDelegacio,hiddenField)}">
        <form:errors path="colaboracioDelegacio.${hiddenField}" cssClass="errorField alert alert-danger" />
    ...
    <table id="colaboracioDelegacio_tableid" class="tdformlabel table-sm table table-bordered table-striped marTop10 table-genapp table-genapp-form" > 
    <tbody>      
