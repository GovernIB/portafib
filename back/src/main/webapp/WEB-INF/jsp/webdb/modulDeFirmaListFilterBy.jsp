...
<div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
  ...
  <input id="${__entry.value.searchBy.fullName}" name="${__entry.value.searchBy.fullName}" class="search-query input-medium" placeholder="${cercaperAF}" type="text" value="${__entry.value.searchByValue}"/>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ModulDeFirmaFields.MODULDEFIRMAID)}">
            <%-- FILTRE NUMERO --%>      
            <div class="input-prepend input-append" style="padding-right: 4px;padding-bottom: 4px;">
              <span class="add-on"><fmt:message key="modulDeFirma.modulDeFirmaID" />:</span>

              <span class="add-on"><fmt:message key="genapp.from" /></span>
              
              <form:input cssClass="input-append input-small" path="modulDeFirmaIDDesde" />
                                       
              
              <span class="add-on"><fmt:message key="genapp.to" /></span>
              
              <form:input cssClass="input-append input-small search-query" path="modulDeFirmaIDFins" />
              
            </div>


        </c:if>
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ModulDeFirmaFields.NOMID)}">
            <%-- FILTRE NUMERO --%>      
            <div class="input-prepend input-append" style="padding-right: 4px;padding-bottom: 4px;">
              <span class="add-on"><fmt:message key="modulDeFirma.nomID" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ModulDeFirmaFields.DESCRIPCIOCURTAID)}">
            <%-- FILTRE NUMERO --%>      
            <div class="input-prepend input-append" style="padding-right: 4px;padding-bottom: 4px;">
              <span class="add-on"><fmt:message key="modulDeFirma.descripcioCurtaID" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ModulDeFirmaFields.CLASSE)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="modulDeFirma.classe" var="classe" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ModulDeFirmaFields.PROPERTIESADMIN)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="modulDeFirma.propertiesAdmin" var="propertiesAdmin" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ModulDeFirmaFields.PROPERTIESENTITAT)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="modulDeFirma.propertiesEntitat" var="propertiesEntitat" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ModulDeFirmaFields.ENTITATID)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="modulDeFirma.entitatID" var="entitatID" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ModulDeFirmaFields.ACTIU)}">
            <%-- FILTRE NUMERO --%>      
            <div class="input-prepend input-append" style="padding-right: 4px;padding-bottom: 4px;">
              <span class="add-on"><fmt:message key="modulDeFirma.actiu" />:</span>
