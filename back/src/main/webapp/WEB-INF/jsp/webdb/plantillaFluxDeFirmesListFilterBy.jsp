...
<un:useConstants var="PlantillaFluxDeFirmesFields" className="es.caib.portafib.model.fields.PlantillaFluxDeFirmesFields"/>
  ...
  <div id="FilterDiv" class="wellgroupfilter formbox" style="${displayFilterDiv} margin-bottom:3px; margin-left: 1px; padding:3px;">
      ...
      <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,PlantillaFluxDeFirmesFields.FLUXDEFIRMESID)}">
            <%-- FILTRE NUMERO --%>      
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
              <span class="add-on"><fmt:message key="plantillaFluxDeFirmes.fluxDeFirmesID" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,PlantillaFluxDeFirmesFields.DESCRIPCIO)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="plantillaFluxDeFirmes.descripcio" var="descripcio" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,PlantillaFluxDeFirmesFields.USUARIENTITATID)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="plantillaFluxDeFirmes.usuariEntitatID" var="usuariEntitatID" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,PlantillaFluxDeFirmesFields.USUARIAPLICACIOID)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="plantillaFluxDeFirmes.usuariAplicacioID" var="usuariAplicacioID" />
