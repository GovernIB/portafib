...
<un:useConstants var="TipusEstatDeFirmaInicialFields" className="es.caib.portafib.model.fields.TipusEstatDeFirmaInicialFields"/>
  ...
  <div id="FilterDiv" class="well formbox" style="${displayFilterDiv} margin-bottom:3px; margin-left: 1px; padding:3px;">
      ...
      <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,TipusEstatDeFirmaInicialFields.TIPUSESTATDEFIRMAINICIALID)}">
            <%-- FILTRE NUMERO --%>      
            <div class="input-prepend input-append" style="padding-right: 4px;padding-bottom: 4px;">
              <span class="add-on"><fmt:message key="tipusEstatDeFirmaInicial.tipusEstatDeFirmaInicialID" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,TipusEstatDeFirmaInicialFields.NOM)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="tipusEstatDeFirmaInicial.nom" var="nom" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,TipusEstatDeFirmaInicialFields.DESCRIPCIO)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="tipusEstatDeFirmaInicial.descripcio" var="descripcio" />
