...
<%@ include file="/WEB-INF/jsp/moduls/includes.jsp"%>
 ...
 <%@include file="../webdb/colaboracioDelegacioFormTitle.jsp" %>

<form:form modelAttribute="colaboracioDelegacioForm" method="${method}"
  enctype="multipart/form-data" onsubmit="preSubmit()" >
  
    <c:set var="contexte" value="${colaboracioDelegacioForm.contexte}"/>
    <form:hidden path="nou" />
  
    <%@include file="../webdb/colaboracioDelegacioFormCorePre.jsp" %>
    
    <%@include file="../webdb/colaboracioDelegacioFormCore.jsp" %>
    
    <%@include file="../webdb/colaboracioDelegacioFormCorePost.jsp" %>
