...
import org.fundaciobit.apisib.apifirmasimple.v1.exceptions.TimeOutException;
 ...
 *
 */
abstract class AbstractApiFirmaSimpleJersey {
   ...
   * @param endPointBase
   */
  public AbstractApiFirmaSimpleJersey(String endPointBase) {
    super();
   ...
   * @param password
   */
  public AbstractApiFirmaSimpleJersey(String endPointBase, String username, String password) {
    this(endPointBase);
