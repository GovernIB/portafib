...
public class UsuariAplicacioLogicaEJB extends UsuariAplicacioEJB implements
  ...
  @EJB(mappedName = PlantillaFluxDeFirmesService.JNDI_NAME, beanName = "PlantillaFluxDeFirmesEJB")
  protected PlantillaFluxDeFirmesService plantillaFluxDeFirmesEjb;
  ...
  @EJB(mappedName = CustodiaInfoService.JNDI_NAME, beanName = "CustodiaInfoEJB")
  protected CustodiaInfoService custodiaInfoEjb;
