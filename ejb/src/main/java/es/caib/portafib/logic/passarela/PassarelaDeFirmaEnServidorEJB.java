...
public class PassarelaDeFirmaEnServidorEJB extends AbstractPassarelaDeFirmaEJB<ISignatureServerPlugin>
    ...
    public PassarelaSignatureInServerResults signDocuments(PassarelaSignaturesSet passarelaSignaturesSet,
        ...
        try {
            ...
            SignaturesSet ss = SignatureUtils.passarelaSignaturesSetToSignaturesSet(this, segellDeTempsPublicEjb,
                    passarelaSignaturesSet, usrApp, perfilDeFirma, configBySignID, entitat, timeStampUrls);
            ...
            for (int i = 0; i < ss.getFileInfoSignatureArray().length; i++) {
                ...
                if (status.getStatus() == StatusSignature.STATUS_FINAL_OK) {
                    ...
                    final IPortaFIBDataSource adaptat = new FileDataSource(
    ...
    public UpgradeResponse upgradeSignature(FirmaSimpleFile signature, FirmaSimpleFile documentDetached,
            ...
            PerfilDeFirma perfilDeFirma, UsuariAplicacioConfiguracio config, EntitatJPA entitat, String languageUI)
        ...
        try {
            if (info != null) {
                upgradedSignature = signaturePlugin.upgradeSignature(signatureData, null, signTypeForm,
        ...
        switch (signTypeID) {
            ...
            case ConstantsV2.TIPUSFIRMA_PADES:
                numFirmesOriginals = PdfUtils.getNumberOfSignaturesInPDF(fitxerOriginal.getInputStream());
            break;
        ...
        if (documentDetached == null) {
            ...
            if (ConstantsV2.TIPUSFIRMA_PADES == signTypeID) {
            ...
            if (ConstantsV2.TIPUSFIRMA_XADES == signTypeID) {
    ...
    private PassarelaFullResults getSignatureStatusAndResults(SignaturesSet ssf, PassarelaCustodyInfo custodyInfo,
        ...
        for (int i = 0; i < ssf.getFileInfoSignatureArray().length; i++) {
            ...
            PassarelaSignatureResult psr = new PassarelaSignatureResult(pfis.getSignID(), signedFile, custodyInfo,
                    validationInfo);
