...
public class PropietatGlobalUtil implements ConstantsV2 {
    ...
    */
    ...
    protected static String getUrlBase(final PerfilDeFirma perfilDeFirma, final String partialKeyProperty)
    ...
    protected static String getString(final String partialPropertyName) {
        try {
            ...
            log.error("Unknown error getting String Property ]" + PORTAFIB_PROPERTY_BASE + partialPropertyName + "[: "
                    + msg, e);
            return null;
        }
    }
    ...
    protected static Long getLong(final String partialPropertyName) {
        try {
            ...
            String msg = I18NLogicUtils.getMessage(e, new Locale(Configuracio.getDefaultLanguage()));
            log.error("Unknown error getting Long Property ]" + PORTAFIB_PROPERTY_BASE + partialPropertyName + "[: "
                    + msg, e);
            return null;
        }
    }
    ...
    protected static Long getLongByEntitat(String entitatID, final String partialPropertyName) {
        try {
            ...
            String msg = I18NLogicUtils.getMessage(e, new Locale(Configuracio.getDefaultLanguage()));
            log.error("Unknown error getting Long Property by entitat " + entitatID + "]" + PORTAFIB_PROPERTY_BASE
                    + partialPropertyName + "[: " + msg, e);
            return null;
        }
    }
    ...
    protected static Boolean getBoolean(final String partialPropertyName) {
        try {
            ...
            String msg = I18NLogicUtils.getMessage(e, new Locale(Configuracio.getDefaultLanguage()));
            log.error("Unknown error getting Boolean Property ]" + PORTAFIB_PROPERTY_BASE + partialPropertyName + "[: "
                    + msg, e);
            return null;
        }
    }

    protected static Boolean getBooleanByEntitat(final String entitatID, final String partialPropertyName) {
        try {
            PropietatGlobalLogicaLocal propietatEjb = EjbManager.getPropietatLogicaEJB();
            return propietatEjb.getBooleanPropertyByEntitat(entitatID, PORTAFIB_PROPERTY_BASE + partialPropertyName);
        } catch (I18NException e) {
            String msg = I18NLogicUtils.getMessage(e, new Locale(Configuracio.getDefaultLanguage()));
            log.error("Unknown error getting Boolean Property by entitat " + entitatID + " ]" + PORTAFIB_PROPERTY_BASE
                    + partialPropertyName + "[: " + msg, e);
            return null;
        }
    }
