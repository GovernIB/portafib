...
public class SignatureUtils {
  ...
  public static int processFileToSign(Locale locale, String entitatID,
      PassarelaFileInfoSignature pfis, File original, File adaptat, EntitatService entitatEjb,
      CodiBarresService codiBarresEjb, UsuariAplicacioJPA usrApp) throws I18NException {
