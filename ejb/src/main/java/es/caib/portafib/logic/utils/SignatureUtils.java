...
public class SignatureUtils {
     ...
     * @return
     */
    public static PolicyInfoSignature getPolicyInfoSignature(EntitatJPA entitat, UsuariAplicacioConfiguracio config) {
    ...
    public static CommonInfoSignature getCommonInfoSignature(EntitatJPA entitat, UsuariAplicacioConfiguracioJPA config,
        ...
        return new CommonInfoSignature(languageUI, CommonInfoSignature.cleanFiltreCertificats(filtreCertificats),
    ...
    public static String getFiltreCertificats(EntitatJPA entitat, UsuariAplicacioConfiguracioJPA config) {
        return config != null && config.getFiltreCertificats() != null
                && !config.getFiltreCertificats().trim().isEmpty() ? config.getFiltreCertificats()
    ...
    public static int convertPortafibSignMode2ApiSignMode(boolean signModeBool, int signType) {
        ...
        if (signModeBool == ConstantsV2.SIGN_MODE_EXPLICIT) {
            // Antic FileInfoSignature.SIGN_MODE_EXPLICIT
            return FileInfoSignature.SIGN_MODE_DETACHED;
        } else {
            ...
            */
            if (signType == ConstantsV2.TIPUSFIRMA_PADES) {
                ...
                return FileInfoSignature.SIGN_MODE_ATTACHED_ENVELOPING;
            }
    ...
    public static SignaturesSet passarelaSignaturesSetToSignaturesSet(AbstractPassarelaDeFirmaLocal passarelaDeFirmaEjb,
            ...
            Map<String, UsuariAplicacioConfiguracioJPA> configBySignID, EntitatJPA entitat, Set<String> timeStampUrls)
            throws I18NException {
...

        {
            ...
            for (PassarelaFileInfoSignature pfis : pss.getFileInfoSignatureArray()) {
                ...
                FileInfoSignature fis = getFileInfoSignature(signID, pdfAdaptat, mime, idname, posicioTaulaFirmesID,
                        ...
                        getFirmatPerFormat(entitat, config, langDoc), timeStampGenerator, pis, pfis.getExpedientCodi(),
  ...
  *
    ...
    */
    ...
    public static String getMotiuDeFirmaFormat(EntitatJPA entitat, UsuariAplicacioConfiguracioJPA config, String lang) {
     ...
     * @throws I18NException
     */
    public static int afegirTaulaDeFirmesCodiSegurVerificacio(File fitxerPDF, StampTaulaDeFirmes stampTaulaDeFirmes,
            StampCustodiaInfo stampCustodiaInfo, boolean acceptTransformPDFA) throws I18NException {
        ...
        try {
            ...
            final int originalNumberOfSigns = PdfUtils.add_TableSign_Attachments_CustodyInfo_PDF(fitxerPDF, tmpDest,
                    null, maxSizeFitxerAdaptat, stampTaulaDeFirmes, stampCustodiaInfo, acceptTransformPDFA);
            ...
            // TODO traduir
            String msg = "Error desconegut afegint taula de firmes a fitxer (" + fitxerPDF.getAbsolutePath() + "): "
                    + e.getMessage();
     ...
     * @throws I18NException
     */
    public static int processFileToSign(Locale locale, String entitatID, PassarelaFileInfoSignature pfis, File original,
            File adaptat, EntitatService entitatEjb, CodiBarresService codiBarresEjb, UsuariAplicacioJPA usrApp)
            throws I18NException {
     ...
     * @throws I18NException
     */
    public static boolean validarFirma(UsuariAplicacioConfiguracio configuracio, EntitatService entitatEjb,
     ...
     * @throws I18NException
     */
    public static boolean comprovarNifFirma(UsuariAplicacioConfiguracio configuracio, EntitatService entitatEjb,
            String entitatID, boolean administrationIdCanBeValidatedFromPlugin) throws I18NException {
