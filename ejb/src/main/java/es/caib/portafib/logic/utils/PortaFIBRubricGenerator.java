...
public class PortaFIBRubricGenerator implements IRubricGenerator {
     ...
     */
    public PortaFIBRubricGenerator(String languageSign, String firmatPerFormat, String motiu,
            PdfRubricRectangle pdfRubricRectangle) {
        super();
    ...
    @Override
    public byte[] genenerateRubricImage(X509Certificate cert, java.util.Date data) throws Exception {
    ...
    public static byte[] getImage(X509Certificate cert, Locale locale, float ample, float altura,
        ...
        log.info(" \n\n\n FIRMAT PER = " + firmatPer + "\n\n\n");

        return getImage(ample, altura, I18NLogicUtils.tradueix(locale, "rubric.firmatper") + ": ", firmatPer,
     ...
     * @throws Exception
     */
    public static byte[] getImage(float ample, float altura, String firmatPerLabel, String firmatPer, String dataLabel,
            String data, String motiuLabel, String motiu) throws Exception {
        ...
        */
        y = drawStringMultipleLine(firmatPerLabel, firmatPer, width, g, font, fontBolt, metrics, metricsBold,
        ...
        // XYZ ZZZZ  !!!!!!!!!!!!!!!!!
        /*
        File f = new File("d:\\tmp\\imatge.jpg");
        log.info("\n\n\n Generada imatge "  + f.getAbsolutePath() + "  firma amb " + result.length + " bytes \n\n\n");
        
        org.apache.commons.io.FileUtils.writeByteArrayToFile(f, result);
        */
    ...
    protected static int drawStringMultipleLine(String textLabel, String text, int width, Graphics g, Font font,
            Font fontBolt, FontMetrics metrics, FontMetrics metricsBold, final int factorSeparacioReduit, int alt,
            int y) {
        String label;
        ...
        if (log.isDebugEnabled()) {
            log.debug(" textLen(" + textLen + ") + labelLen(" + labelLen + ") + " + (5 * factorSeparacioReduit)
                    + " > width (" + width + ")");
        }
