...
public interface UsuariPersonaLogicaLocal extends UsuariPersonaService {
    ...
    public UsuariPersonaJPA createFull(UsuariPersonaJPA usuariPersonaJPA) throws I18NException, I18NValidationException;
    ...
    public String updateUsernameOfPerson(String currentUsername, String newUsername, String langUI);
