...
public class ConfiguracioUsuariAplicacioLogicaEJB extends UsuariAplicacioConfiguracioEJB
    ...
    protected void checkTePermisPerUsDeFirma(final String usuariAplicacioID, String codiPerfil, final int usFirma,
        ...
        switch (usFirma) {
            ...
            default:
                ...
                throw new I18NException("genapp.comodi",
                        "Ús de Firma amb codi  " + usFirma + " desconegut." + "Consulti amb l'Administrador.");
        ...
        if (!tePermis) {
            ...
            // XYZ ZZZ TRA Traduir
            throw new I18NException("genapp.comodi",
                    "La configuració de firma " + config.getNom() + " enllaçada amb el perfil de firma amb codi "
                            + codiPerfil + " i associat a l'usuari aplicació " + usuariAplicacioID
    ...
    public PerfilDeFirma getPerfilDeFirma(final String usuariAplicacioID, String codiPerfil) throws I18NException {
        ...
        if (codiPerfil == null || codiPerfil.trim().length() == 0) {
            ...
            throw new I18NException("genapp.comodi",
                    "S'ha fet una cridada REST amb l´usuari aplicació " + usuariAplicacioID
                            + " però s'ha indicat un perfil de firma null o buit." + ". Consulti amb l'Administrador.");
        }
        ...
        // PerfilsPerUsuariAplicacio perfil;
        {
            ...
            Where w = Where.AND(
                    PerfilsPerUsuariAplicacioFields.PERFILDEFIRMAID.equal(perfilDeFirma.getUsuariAplicacioPerfilID()),
            ...
            if (perfils == null || perfils.size() == 0) {
                // XYZ ZZZ TRA Traduir
                throw new I18NException("genapp.comodi",
                        "El codi de perfil " + codiPerfil + " no està associat a l'usuari aplicació "
                                + usuariAplicacioID + ". Consulti amb l'Administrador.");
            }
        }
    ...
    protected PerfilDeFirma getPerfilDeFirmaByCodi(String codiPerfil) throws I18NException {
        ...
        {
            List<PerfilDeFirma> list = perfilDeFirmaEjb.select(PerfilDeFirmaFields.CODI.equal(codiPerfil));

            if (list == null || list.size() == 0) {
                // XYZ ZZZ TRA Traduir
                throw new I18NException("genapp.comodi",
                        "El codi de perfil " + codiPerfil + " no existeix. Consulti amb l'Administrador.");
            }
    ...
    public UsuariAplicacioConfiguracioJPA getConfiguracioUsuariAplicacioPerApiPortafibWS1(
        ...
        Where where = new PerfilsPerUsuariAplicacioQueryPath().PERFILDEFIRMA().CONFIGURACIODEFIRMA1().USENFIRMAWS1()
                .equal(true);
        ...
        UsuariAplicacioConfiguracioJPA config = (UsuariAplicacioConfiguracioJPA) findByPrimaryKey(
                perfilDeFirma.getConfiguracioDeFirma1ID());
    ...
    public PerfilConfiguracionsDeFirma getConfiguracioUsuariAplicacioPerPassarela(String usuariAplicacioID,
        ...
        PerfilDeFirma perfilDeFirma = getPerfilDeFirmaPerPassarela(usuariAplicacioID, esFirmaEnServidor);

        final int usFirma = esFirmaEnServidor ? ConstantsV2.US_FIRMA_CONF_APP_PASSARELAFIRMASERVIDOR
        ...
        for (PassarelaFileInfoSignature passarelaFileInfoSignature : signaturesSet.getFileInfoSignatureArray()) {
            ...
            ConfiguracioUsuariAplicacioPassarelaUtils cfgUtils = new ConfiguracioUsuariAplicacioPassarelaUtils(usFirma,
                    passarelaCommonInfoSignature, passarelaFileInfoSignature);
    ...
    protected PerfilDeFirma getPerfilDeFirmaPerPassarela(final String usuariAplicacioID,
        ...
        if (esFirmaEnServidor) {
            usFirmaPassarela = new PerfilsPerUsuariAplicacioQueryPath().PERFILDEFIRMA().CONFIGURACIODEFIRMA1()
    ...
    public PerfilDeFirma getPerfilDeFirmaPerApiFirmaSimple(final String usuariAplicacioID,
        ...
        if (esFirmaEnServidor) {
            usFirmaApiFirmaSimple = new PerfilsPerUsuariAplicacioQueryPath().PERFILDEFIRMA().CONFIGURACIODEFIRMA1()
    ...
    public PerfilDeFirma getPerfilDeFirmaPerApiFirmaAsyncRest(final String usuariAplicacioID) throws I18NException {
        ...
        return getPerfilDeFirmaUnike(usuariAplicacioID, where, nomus, "perfil.apifirmaasyncrest.perfilbuit", false);
    }

    protected PerfilDeFirma getPerfilDeFirmaUnike(final String usuariAplicacioID, Where where, String nomus,
            String codiError, boolean onlyOneCondition) throws I18NException {
        ...
        List<String> codisPerfil = perfilsPerUsuariAplicacioEjb.executeQuery(
                ...
                Where.AND(PerfilsPerUsuariAplicacioFields.USUARIAPLICACIOID.equal(usuariAplicacioID), where));
        ...
        if (onlyOneCondition) {
            if (perfilDeFirma.getCondicio() != null || perfilDeFirma.getConfiguracioDeFirma2ID() != null
                ...
                // XYZ ZZZ TRA
                throw new I18NException("genapp.comodi",
                        "El perfil amb codi " + codiPerfil + " que esta assignat a l´usuari aplicació "
                                + usuariAplicacioID + ", que es fa servir per " + nomus
    ...
    public UsuariAplicacioConfiguracioJPA getConfiguracioUsuariAplicacioPerUpgrade(String usuariAplicacioID,
            PerfilDeFirma perfilDeFirma, FirmaSimpleUpgradeRequest firmaSimpleUpgradeRequest) throws I18NException {
        ...
        if (upgradeID == null) {
            ...
            throw new I18NException("genapp.codi",
                    "L´usuari aplicació " + usuariAplicacioID
    ...
    @Override
    @PermitAll
    public PerfilConfiguracionsDeFirma getConfiguracioFirmaPerApiFirmaSimpleEnServidor(String usuariAplicacioID,
            String codiPerfil, FirmaSimpleSignDocumentRequest firmaSimpleSignDocumentRequest) throws I18NException {
    ...
    @Override
    public UsuariAplicacioConfiguracioJPA getConfiguracioFirmaPerApiFirmaAsyncSimple(String usuariAplicacioID,
            String codiPerfil, FirmaAsyncSimpleSignatureRequestWithSignBlockList signatureRequest)
            throws I18NException {
    ...
    public UsuariAplicacioConfiguracioJPA getConfiguracioFirmaPerApiFirmaSimpleWeb(String usuariAplicacioID,
            PerfilDeFirma perfilDeFirma, FirmaSimpleSignDocumentRequest firmaSimpleSignDocumentRequest)
            throws I18NException {
    ...
    protected UsuariAplicacioConfiguracioJPA avaluarCondicio(String usuariAplicacioID, PerfilDeFirma perfilDeFirma,
        ...
        if (condicio == null || condicio.trim().length() == 0) {
            ...
            try {
                errorOrConfig = TemplateEngine.processExpressionLanguage(condicio,
                        configuracioFirmaUtils.getParameters());
            } catch (IOException e) {
                // XYZ ZZZ TRAD
                throw new I18NException(e, "genapp.comodi", new I18NArgumentString(
                        "Error processant condició del perfil " + perfilDeFirma.getCodi() + ": " + e.getMessage()));
            }
            ...
            try {
                ...
                // XYZ ZZZ TRAD
                throw new I18NException("genapp.comodi",
                        new I18NArgumentString("El processat de la condició del perfil " + perfilDeFirma.getCodi()
            ...
            if (configID == null) {
                // XYZ ZZZ TRAD
                throw new I18NException("genapp.comodi", "La configuració " + configPos + " del perfil "
                        + perfilDeFirma.getCodi() + " no està definida.");
            }
        }

        UsuariAplicacioConfiguracioJPA config = findByPrimaryKey(configID);
        checkTePermisPerUsDeFirma(usuariAplicacioID, perfilDeFirma.getCodi(), configuracioFirmaUtils.getUsFirma(),
                config);
