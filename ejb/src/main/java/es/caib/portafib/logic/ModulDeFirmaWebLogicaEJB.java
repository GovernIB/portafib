...
import es.caib.portafib.ejb.PluginFirmaWebPerUsuariEntitatService;
...
public class ModulDeFirmaWebLogicaEJB extends AbstractPluginIBLogicaEJB<ISignatureWebPlugin>
    ...
    public List<Plugin> getAllPluginsUsuariEntitatAplicacions(String usuariEntitatID, Set<String> usuarisAplicacioID)
        ...
        List<UsuariAplicacio> usuarisAplicacio = usuariAplicacioEjb
                .select(UsuariAplicacioFields.USUARIAPLICACIOID.in(usuarisAplicacioID));
        if (usuarisAplicacio.isEmpty()) {
            return null;
        }
        ...
        switch (usuariEntitat.getPoliticaDePluginFirmaWeb()) {
            ...
            case ConstantsV2.POLITICA_PLUGIN_FIRMA_WEB_NOMES_PLUGINS_ENTITAT:
                // L'usuari Entitat té la politica per defecte, per tant calculam els plugins comuns de l'usuari aplicació.
            ...
            case ConstantsV2.POLITICA_PLUGIN_FIRMA_WEB_ENTITAT_I_ADDICIONALS:
                ...
                return select(Where.OR(
                        Where.AND(getWhereAllPluginsUsuarisAplicacio(usuarisAplicacio),
            ...
            default:
                log.warn(
                        "Política de plugins de firma web desconeguda: " + usuariEntitat.getPoliticaDePluginFirmaWeb());
                return null;
        }
    }
    ...
    private Where getWhereAllPluginsUsuarisAplicacio(List<UsuariAplicacio> usuarisAplicacio) throws I18NException {
        ...
        for (UsuariAplicacio usuariAplicacio : usuarisAplicacio) {
            ...
            if (usuariAplicacio
                    .getPoliticaDePluginFirmaWeb() == ConstantsV2.POLITICA_PLUGIN_FIRMA_WEB_NOMES_PLUGINS_ENTITAT) {
    ...
    private Where getWhereAllPluginsUsuariAplicacio(UsuariAplicacio ua) throws I18NException {
        ...
        switch (ua.getPoliticaDePluginFirmaWeb()) {
            ...
            case ConstantsV2.POLITICA_PLUGIN_FIRMA_WEB_ENTITAT_I_ADDICIONALS:
                ...
                return Where.OR(
                        Where.AND(getWhere(ua.getEntitatID()),
    ...
    private Where getWherePluginsAfegirUsuariAplicacio(String usuariAplicacioID) throws I18NException {
        return PLUGINID.in(
                pluginFirmaWebPerUsuariAplicacioEjb.getSubQuery(PluginFirmaWebPerUsuariAplicacioFields.PLUGINFIRMAWEBID,
                        Where.AND(PluginFirmaWebPerUsuariAplicacioFields.USUARIAPLICACIOID.equal(usuariAplicacioID),
    ...
    private Where getWherePluginsAfegirUsuariEntitat(String usuariEntitatID) throws I18NException {
        return PLUGINID
                .in(pluginFirmaWebPerUsuariEntitatEjb.getSubQuery(PluginFirmaWebPerUsuariEntitatFields.PLUGINFIRMAWEBID,
                        Where.AND(PluginFirmaWebPerUsuariEntitatFields.USUARIENTITATID.equal(usuariEntitatID),
    ...
    private Where getWherePluginsLlevarUsuariEntitat(String usuariEntitatID) throws I18NException {
        return PLUGINID.notIn(
                pluginFirmaWebPerUsuariEntitatEjb.getSubQuery(PluginFirmaWebPerUsuariEntitatFields.PLUGINFIRMAWEBID,
                        Where.AND(PluginFirmaWebPerUsuariEntitatFields.USUARIENTITATID.equal(usuariEntitatID),
                                PluginFirmaWebPerUsuariEntitatFields.ACCIO.equal(-1))));
    }
