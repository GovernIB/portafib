...
public class FirmaEventList implements IFirmaEventListener, ConstantsV2 {
    ...
    public void requerit_per_validar(PeticioDeFirmaJPA peticioDeFirma, EstatDeFirma estatDeFirma) throws I18NException {
        list.add(new FirmaEvent(NOTIFICACIOAVIS_REQUERIT_PER_VALIDAR, FirmaEvent.PRIORITAT_NORMAL, peticioDeFirma,
                estatDeFirma));
    }

    public void descartat_per_validar(PeticioDeFirmaJPA peticioDeFirma, EstatDeFirma estatDeFirma)
            throws I18NException {
        list.add(new FirmaEvent(NOTIFICACIOAVIS_DESCARTAT_PER_VALIDAR, FirmaEvent.PRIORITAT_BAIXA, peticioDeFirma,
                estatDeFirma));
    }

    public void requerit_per_firmar(PeticioDeFirmaJPA peticioDeFirma, EstatDeFirma estatDeFirma) throws I18NException {
        list.add(new FirmaEvent(NOTIFICACIOAVIS_REQUERIT_PER_FIRMAR, FirmaEvent.PRIORITAT_NORMAL, peticioDeFirma,
                estatDeFirma));
    }

    public void requerit_per_revisar(PeticioDeFirmaJPA peticioDeFirma, EstatDeFirma estatDeFirma) throws I18NException {
        list.add(new FirmaEvent(NOTIFICACIOAVIS_REQUERIT_PER_REVISAR, FirmaEvent.PRIORITAT_NORMAL, peticioDeFirma,
                estatDeFirma));
    }

    public void descartat_per_firmar(PeticioDeFirmaJPA peticioDeFirma, EstatDeFirma estatDeFirma) throws I18NException {
        list.add(new FirmaEvent(NOTIFICACIOAVIS_DESCARTAT_PER_FIRMAR, FirmaEvent.PRIORITAT_BAIXA, peticioDeFirma,
                estatDeFirma));
    }
    ...
    public void firma_parcial(PeticioDeFirmaJPA peticioDeFirma, EstatDeFirma estatDeFirma) throws I18NException {
        list.add(
                new FirmaEvent(NOTIFICACIOAVIS_FIRMA_PARCIAL, FirmaEvent.PRIORITAT_ALTA, peticioDeFirma, estatDeFirma));
    }
    ...
    public void peticio_rebutjada(PeticioDeFirmaJPA peticioDeFirma, EstatDeFirma estatDeFirma) throws I18NException {
        list.add(new FirmaEvent(NOTIFICACIOAVIS_PETICIO_REBUTJADA, FirmaEvent.PRIORITAT_NORMAL, peticioDeFirma,
                estatDeFirma));
    }
