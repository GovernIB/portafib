...
public class FirmaEvent implements Cloneable, Serializable {
     ...
     * @throws Exception 
     */
    public FirmaEvent(long eventID, int prioritat, PeticioDeFirmaJPA peticioDeFirma, EstatDeFirma estatDeFirma)
    ...
    */
    ...
    public void setEstatDeFirmaColaboracioDelegacioDestinatariID(String estatDeFirmaColaboracioDelegacioDestinatariID) {
