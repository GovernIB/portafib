...
public class CustodiaInfoLogicaEJB extends CustodiaInfoEJB implements CustodiaInfoLogicaLocal, ConstantsV2 {
    ...
    protected Integer internalGetPoliticaDeCustodiaIDFinal(EntitatJPA entitatJPA, int politicaCustodia, String name)
            throws I18NException {
    ...
    protected CustodiaInformation internalGetCustodiaInformation(EntitatJPA entitatJPA, int politicaCustodia,
            String name,
            // requerid per include
            boolean constructCustodiaInfo, CustodiaInfoJPA custodiaSentByUser, String titol, String usuariAplicacioID,
        ...
        if (politicaCustodia == ConstantsV2.POLITICA_CUSTODIA_POLITICA_DE_CUSTODIA_DEFINIDA_EN_ENTITAT) {
            return checkPotCustodiarE(entitatJPA, constructCustodiaInfo, custodiaSentByUser, titol, usuariAplicacioID,
                    usuariEntitatID);
        }
        ...
        switch (politicaCustodia) {
            ...
            case ConstantsV2.POLITICA_CUSTODIA_SENSE_CUSTODIA_O_POLITICA_DEFINIDA_EN_ENTITAT_PER_DEFECTE_NO_ACTIU: {
                ...
                CustodiaInformation ciEntitat = checkPotCustodiarE(entitatJPA, true, null, titol, usuariAplicacioID,
                        usuariEntitatID);
            ...
            case ConstantsV2.POLITICA_CUSTODIA_SENSE_CUSTODIA_O_POLITICA_DEFINIDA_EN_ENTITAT_PER_DEFECTE_ACTIU: {
                CustodiaInformation ciEntitat = checkPotCustodiarE(entitatJPA, constructCustodiaInfo,
                        custodiaSentByUser, titol, usuariAplicacioID, usuariEntitatID);
                if (ciEntitat.custodiaInfo == null) {
                    return new CustodiaInformation(ConstantsV2.POLITICA_CUSTODIA_NO_PERMETRE);
                } else {
            ...
            case ConstantsV2.POLITICA_CUSTODIA_OBLIGATORI_PLANTILLA_DEFINIDA_A_CONTINUACIO: {
                ...
                if (constructCustodiaInfo) {
                    custodiaInfo = generateCustodiaInfoDefinidaAContinuacioForUsuariEntitatUsuariAplicacio(titol,
            ...
            case ConstantsV2.POLITICA_CUSTODIA_NOMES_PLANTILLES_ENTITAT:
                ...
                throw new I18NException("genapp.comodi",
                        "Politica de Custodia (id = " + politicaCustodia + ") no suportada per PortaFIB per " + name);
    ...
    protected CustodiaInfoJPA generateCustodiaInfoDefinidaAContinuacioForUsuariEntitatUsuariAplicacio(String titol,
            String usuariAplicacioID, String usuariEntitatID) throws I18NException, I18NValidationException {
        ...
        CustodiaInfoJPA custodiaInfoPersonaAplicacio = custodiaInfoEjb.findByPrimaryKey(custodiaObligatoriaID);

        // Feim una còpia de la custòdia definida per entitat
        CustodiaInfoJPA custodiaInfo;
        custodiaInfo = cloneCustodiaInfo(titol, usuariAplicacioID, usuariEntitatID, custodiaInfoPersonaAplicacio);
        {
            // Check custodia
            CustodiaInfoBeanValidator custodiaValidator = new CustodiaInfoBeanValidator(codiBarresEjb, custodiaInfoEjb,
                    entitatEjb, pluginDeCustodiaLogicaEjb, usuariAplicacioEjb, usuariEntitatEjb);
    ...
    protected CustodiaInformation checkPotCustodiarE(EntitatJPA entitat,
            // requerid per include
            boolean includeCustodiaInfo, CustodiaInfoJPA custodiaSentByUser, String titol, String usuariAplicacioID,
            String usuariEntitatID) throws I18NException, I18NValidationException {
        if (entitat == null) {
            throw new I18NException("genapp.comodi", "Usuari Entitat val null");
        }
        ...
        switch (politicaCustodia) {
            ...
            case ConstantsV2.POLITICA_CUSTODIA_SENSE_CUSTODIA_O_POLITICA_DEFINIDA_EN_ENTITAT_PER_DEFECTE_ACTIU: {
                ...
                if (includeCustodiaInfo) {
                    ...
                    custodiaInfo = getCustodiaInfoOfEntitat(titol, usuariAplicacioID, usuariEntitatID, entitatID);
                } else {
                    custodiaInfo = null;
                }
                return new CustodiaInformation(politicaCustodia, custodiaInfo);
    ...
    protected CustodiaInfoJPA getCustodiaInfoOfEntitat(String titol, String usuariAplicacioID, String usuariEntitatID,
            String entitatID) throws I18NException, I18NValidationException {
        CustodiaInfoJPA custodiaInfo;
        ...
        if (defaultCustodiaInfoID == null) {
            ...
            // Feim una còpia de la custòdia definida per entitat
            custodiaInfo = cloneCustodiaInfo(titol, usuariAplicacioID, usuariEntitatID, custodiaInfoEntitat);
            {
                // Check custodia
                CustodiaInfoBeanValidator custodiaValidator = new CustodiaInfoBeanValidator(codiBarresEjb,
                        custodiaInfoEjb, entitatEjb, pluginDeCustodiaLogicaEjb, usuariAplicacioEjb, usuariEntitatEjb);
                final boolean isNou = true;
    ...
    protected CustodiaInfoJPA cloneCustodiaInfo(String titol, String usuariAplicacioID, String usuariEntitatID,
    ...
    public CustodiaInfo getCustodyInfoOnCreatePeticio(PeticioDeFirmaJPA peticio, EntitatJPA entitatJPA,
            UsuariEntitat usuariEntitat, UsuariAplicacio usuariAplicacio)
    ...
    protected CustodiaInfo searchDefaultCustodyInfo(PeticioDeFirmaJPA peticio, EntitatJPA entitatJPA,
            boolean onCreatePeticio, UsuariEntitat usuariEntitat, UsuariAplicacio usuariAplicacio)
            throws I18NException, I18NValidationException {
        ...
        switch (peticio.getOrigenPeticioDeFirma()) {
            ...
            case ORIGEN_PETICIO_DE_FIRMA_SOLICITANT_WEB: {
                ...
                onlyDef = this.searchDefaultCustodyInfo(peticio, entitatJPA, politicaCustodia, "soli web", titol,
                        onCreatePeticio, usuariAplicacio, usuariEntitat);
            }
            break;
    ...
    protected CustodiaInfo searchDefaultCustodyInfo(PeticioDeFirmaJPA peticio, EntitatJPA entitatJPA,
            int politicaCustodia, String name, String titol, boolean onCreatePeticio, UsuariAplicacio usuariAplicacio,
        ...
        switch (politicaCustodia) {
            ...
            case ConstantsV2.POLITICA_CUSTODIA_SENSE_CUSTODIA_O_POLITICA_DEFINIDA_EN_ENTITAT_PER_DEFECTE_NO_ACTIU:
                if (onCreatePeticio) {
                    ...
                    CustodiaInfo custodiaEntitat = searchDefaultCustodyInfoE(peticio, entitatJPA, titol,
                            usuariAplicacioID, usuariEntitatID, onCreatePeticio);
            ...
            case ConstantsV2.POLITICA_CUSTODIA_LLIBERTAT_TOTAL:
                if (onCreatePeticio) {
                    ...
                    return createCustodiaInfoLlibertatTotal(entitatJPA.getEntitatID(), titol, usuariAplicacioID,
                            usuariEntitatID);
                }

                // Obligatori Plantilla definida en Entitat, usuari-entitat o usuari-aplicació.
            case ConstantsV2.POLITICA_CUSTODIA_OBLIGATORI_PLANTILLA_DEFINIDA_A_CONTINUACIO: {
                return generateCustodiaInfoDefinidaAContinuacioForUsuariEntitatUsuariAplicacio(titol, usuariAplicacioID,
                        usuariEntitatID);
            }
    ...
    protected CustodiaInfoJPA createCustodiaInfoLlibertatTotal(String entitatID, String titol, String usuariAplicacioID,
            String usuariEntitatID) throws I18NException {
    ...
    public CustodiaForStartPeticioDeFirma custodiaCommonActionsOnStartPeticioDeFirma(PeticioDeFirmaJPA peticioDeFirma,
        ...
        if (custodiaInfo != null) {
            ...
            if (custodiaInfo.isCustodiar()) {
                ...
                Map<String, Object> parameters = getAdditionalParametersForDocumentCustody(peticioDeFirma, null,
                        custodiaInfo);
                ...
                try {
                    ...
                    if (log.isDebugEnabled()) {
                        log.debug(
                                "custodiaInfo.CsvGenerationDefinition => " + custodiaInfo.getCsvGenerationDefinition());
                        log.debug("custodiaInfo.getCsvValidationWeb => " + custodiaInfo.getCsvValidationWeb());
                        log.debug(
                                "custodiaInfo.setOriginalFileDirectUrl => " + custodiaInfo.getOriginalFileDirectUrl());
                    ...
                    custodiaForStartPeticioDeFirma = new CustodiaForStartPeticioDeFirma(custodyID, custodiaInfo,
                            plugin);
    ...
    public es.caib.portafib.logic.utils.StampCustodiaInfo custodiaPAdESActionsOnStartPeticioDeFirma(
        ...
        if (custodiaInfo != null) {
            ...
            Map<String, Object> additionParameters = getAdditionalParametersForDocumentCustody(peticioDeFirma, null,
                    custodiaInfo);
            ...
            try {
                ...
                throw new I18NException(ce, "genapp.comodi",
                        new I18NArgumentString("Error intentant obtenir SpecialValue de Custòdia: " + ce.getMessage()));
            }
            ...
            IBarcodePlugin barcode = (IBarcodePlugin) PluginsManager.instancePluginByClassName(javaName, "",
                    Configuracio.getSystemAndFileProperties());
            if (barcode == null) {
                throw new I18NException("plugin.donotinstantiate", javaName);
            }

            custodiaInfoStamp = new StampCustodiaInfo((int) custodiaInfo.getMissatgePosicioPaginaID(), missatge,
                    barcode, barcodeText, custodiaInfo.getPagines());
    ...
    @Override
    public void custodiaThingToDoOnFinishPeticioDeFirma(String fitxerAFirmarNom, IPortaFIBDataSource fitxerAFirmar,
        ...
        if (custInfo != null && custInfo.isCustodiar() && signatureFile != null) {
            ...
            Map<String, Object> additionParameters = this.getAdditionalParametersForDocumentCustody(peticioDeFirma,
                    firma, custInfo);
