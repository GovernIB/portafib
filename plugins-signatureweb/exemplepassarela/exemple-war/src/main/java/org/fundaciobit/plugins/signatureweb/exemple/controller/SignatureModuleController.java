...
public class SignatureModuleController {
  ...
  public ModelAndView showSignatureModule(
    ...
    String urlToPluginWebPage;
    urlToPluginWebPage = signatureModuleEjb.signDocuments(request, absoluteRequestPluginBasePath,
        relativeRequestPluginBasePath, signaturesSetID);
...
*/
    ...
    signatureModuleEjb.requestPlugin(request, response, absoluteRequestPluginBasePath,
        relativeRequestPluginBasePath, signaturesSetID, signatureIndex, query, isPost, uploadedFiles);
  ...
  public static ModelAndView startSignatureProcess(HttpServletRequest request,
       String view, SignatureModuleLocal signatureModuleEjb, ExempleSignaturesSet signaturesSet) throws Exception {
