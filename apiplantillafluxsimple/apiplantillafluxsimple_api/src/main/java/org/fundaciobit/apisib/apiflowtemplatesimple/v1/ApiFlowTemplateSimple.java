...
public interface ApiFlowTemplateSimple {
   ...
   */
  public String getUrlToViewFlowTemplate(FlowTemplateSimpleViewFlowTemplateRequest viewFlowRequest)
      throws AbstractApisIBException;
   ...
   * @throws AbstractApisIBException
   */
  public FlowTemplateSimpleFlowTemplate getFlowInfoByFlowTemplateID(String flowTemplateID) throws AbstractApisIBException;
