# portafib-api-interna-client-firmaservidor-v1
...
<dependency>
  ...
  <artifactId>portafib-api-interna-client-firmaservidor-v1</artifactId>
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'portafib-api-interna-client-firmaservidor-v1' jar has been published to maven central.
    mavenLocal()       // Needed if the 'portafib-api-interna-client-firmaservidor-v1' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "es.caib.portafib:portafib-api-interna-client-firmaservidor-v1:1.0-SNAPSHOT"
  }
```
...
- `target/portafib-api-interna-client-firmaservidor-v1-1.0-SNAPSHOT.jar`
- `target/lib/*.jar`
...
import es.caib.portafib.apiinterna.client.firmaservidor.v1.services.*;
import es.caib.portafib.apiinterna.client.firmaservidor.v1.services.auth.*;
import es.caib.portafib.apiinterna.client.firmaservidor.v1.model.*;
